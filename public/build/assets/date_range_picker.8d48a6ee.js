import{r as t,o as Q,bN as X,W as L,bF as i,bG as c,bW as Z,bH as s,aU as ss,V as _,c4 as I,e as a,al as $,bS as v,bM as p,af as r,bL as l,c5 as y,ab as ns,bO as os,cc as es}from"./index.fb9dc0c3.js";/* empty css                     */import{_ as m}from"./highlight.627afd22.js";import{C as N}from"./custom-flatpickr.b1f2c3bf.js";import"./use-meta.c39fc0d4.js";/* empty css                        */const ls={class:"container"},ts={class:"container"},as={class:"nav sidenav"},is={class:"sidenav-content"},ds={class:"row"},cs={class:"col-lg-12 col-12 layout-spacing"},rs={class:"statbox panel box box-shadow"},us={class:"panel-body"},vs={class:"form-group mb-0"},ps={class:"code-section-container show-code"},ms={key:0,class:"code-section text-start"},gs={class:"col-lg-12 col-12 layout-spacing"},bs={class:"statbox panel box box-shadow"},_s={class:"panel-body"},fs={class:"form-group mb-0"},xs={class:"code-section-container show-code"},ws={key:0,class:"code-section text-start"},ks={class:"col-lg-12 col-12 layout-spacing"},hs={class:"statbox panel box box-shadow"},ys={class:"panel-body"},Cs={class:"form-group mb-0"},Vs={class:"code-section-container show-code"},Us={key:0,class:"code-section text-start"},Ts={class:"col-lg-12 col-12 layout-spacing"},Fs={class:"statbox panel box box-shadow"},$s={class:"panel-body"},Ns={class:"form-group mb-0"},Ss={class:"code-section-container show-code"},Bs={key:0,class:"code-section text-start"},Ds={class:"row"},Ms={class:"col-lg-12 col-12 layout-spacing"},Ls={class:"statbox panel box box-shadow"},js={class:"panel-body"},Hs={class:"custom-progress progress-up",style:{width:"100%"}},Ps={class:"range-count"},Rs={class:"range-count-number"},Js={class:"code-section-container show-code"},Is={key:0,class:"code-section text-start"},Os={class:"col-lg-12 col-12 layout-spacing"},Ys={class:"statbox panel box box-shadow"},As={class:"panel-body"},Ws={class:"custom-progress top-right progress-up",style:{width:"100%"}},Es={class:"range-count"},Gs={class:"range-count-number"},qs={class:"code-section-container show-code"},zs={key:0,class:"code-section text-start"},Ks={class:"col-lg-12 col-12 layout-spacing"},Qs={class:"statbox panel box box-shadow"},Xs={class:"panel-body"},Zs={class:"custom-progress progress-down",style:{width:"100%"}},sn={class:"range-count"},nn={class:"range-count-number"},on={class:"code-section-container show-code"},en={key:0,class:"code-section text-start"},ln={class:"col-lg-12 col-12 layout-spacing"},tn={class:"statbox panel box box-shadow"},an={class:"panel-body"},dn={class:"custom-progress bottom-right progress-down",style:{width:"100%"}},cn={class:"range-count"},rn={class:"range-count-number"},un={class:"code-section-container show-code"},vn={key:0,class:"code-section text-start"},pn={class:"row"},mn={class:"col-lg-12 layout-spacing"},gn={class:"row"},bn={class:"col-lg-12 mb-4"},_n={class:"statbox panel box box-shadow"},fn={class:"panel-body align-center"},xn={class:"container"},wn={class:"row mt-4 mb-4"},kn={class:"col-lg-6 mb-3"},hn=["value"],yn={class:"col-lg-6"},Cn={class:"code-section-container show-code"},Vn={key:0,class:"code-section text-start"},Un={class:"col-lg-12"},Tn={class:"statbox panel box box-shadow"},Fn={class:"panel-body align-center"},$n={class:"container"},Nn={class:"row mt-4 mb-4"},Sn={class:"col-lg-6"},Bn={class:"example-val"},Dn={class:"precentage-val"},Mn={class:"col-lg-6 text-end"},Ln={class:"example-val"},jn={class:"precentage-val"},Hn={class:"code-section-container show-code"},Pn={key:0,class:"code-section text-start"},Rn={class:"col-lg-12 layout-spacing"},Jn={class:"statbox panel box box-shadow"},In={class:"panel-body align-center"},On={class:"container"},Yn={class:"row mb-4"},An={class:"col-lg-12 mb-5"},Wn={class:"example-val mt-4 d-inline-block"},En={class:"row mb-0"},Gn={class:"col-lg-12 mb-5"},qn={class:"example-val mt-4 d-inline-block"},zn={class:"row"},Kn={class:"col-lg-12"},Qn={class:"code-section-container show-code"},Xn={key:0,class:"code-section text-start"},ao={__name:"date_range_picker",setup(Zn){const d=t([]),j=t("2020-09-04"),H=t("2020-09-19 12:00"),P=t(""),R=t("13:45"),C=t(0),V=t(0),U=t(0),T=t(0),g=t(10),b=t(30),w=t(500),k=t(4e3),S=t(0),B=t(0),f=t(60),x=t(80),h=t(!1),D=t([60,80]);Q(()=>{M(g.value,b.value)});const u=e=>{d.value.includes(e)?d.value=d.value.filter(n=>n!=e):d.value.push(e)},M=(e,n)=>{g.value=parseInt(e),b.value=parseInt(n)},O=e=>{e&&(g.value=Math.round(parseFloat(e[0])),b.value=parseFloat(e[1]))},Y=e=>{e&&(w.value=e[0],k.value=e[1],S.value=parseFloat((w.value*.01).toFixed(2)),B.value=parseFloat((k.value*.01).toFixed(2)))},A=e=>{e&&(f.value=parseFloat(e[0]),G())},W=e=>{e&&(x.value=parseFloat(e[0]))},E=()=>{D.value=[Number(f.value),Number(x.value)]},G=()=>{if(h.value){let e=JSON.parse(JSON.stringify(f.value));e-=D.value[0]-D.value[1],x.value=parseFloat(e.toFixed(2))}};return(e,n)=>{const F=X("vue-nouislider"),q=L("scroll-spy-active"),z=L("scroll-spy-link"),K=L("scroll-spy");return i(),c("div",ls,[(i(),Z(ss,{to:"#breadcrumb"},[n[24]||(n[24]=s("ul",{class:"navbar-nav flex-row"},[s("li",null,[s("div",{class:"page-header"},[s("nav",{class:"breadcrumb-one","aria-label":"breadcrumb"},[s("ol",{class:"breadcrumb"},[s("li",{class:"breadcrumb-item"},[s("a",{href:"javascript:;"},"Forms")]),s("li",{class:"breadcrumb-item active","aria-current":"page"},[s("span",null,"Date and Range Picker")])])])])])],-1))])),s("div",ts,[s("div",as,[_((i(),c("div",is,n[25]||(n[25]=[s("a",{href:"#date_time_picker",class:"nav-link"},"Date Time Picker",-1),s("a",{href:"#js_range_slider",class:"nav-link"},"JS Range Slider",-1),s("a",{href:"#noUi_sliders",class:"nav-link"},"noUi Sliders",-1)]))),[[q],[z]])]),n[70]||(n[70]=I('<div class="row layout-top-spacing"><div class="col-12"><div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg> Documentation: <a target="_blank" href="https://www.npmjs.com/package/vue-flatpickr-component" class="text-info"> https://www.npmjs.com/package/vue-flatpickr-component </a></div></div></div>',1)),_((i(),c("div",null,[s("div",ds,[n[41]||(n[41]=s("div",{id:"date_time_picker",class:"col-lg-12 layout-top-spacing"},[s("div",{class:"seperator-header"},[s("h4",{class:""}," Date and Time Picker ")])],-1)),s("div",cs,[s("div",rs,[n[28]||(n[28]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Basic")])])],-1)),s("div",us,[s("div",vs,[a($(N),{modelValue:j.value,"onUpdate:modelValue":n[0]||(n[0]=o=>j.value=o),class:"form-control flatpickr active"},null,8,["modelValue"])]),s("div",ps,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[1]||(n[1]=o=>u("code1"))},n[26]||(n[26]=[s("span",null,"Code",-1)])),d.value.includes("code1")?(i(),c("div",ms,[a(m,null,{default:v(()=>n[27]||(n[27]=[s("pre",null,`<!-- Basic -->
...
`,-1)])),_:1})])):p("",!0)])])])])]),s("div",Ds,[n[58]||(n[58]=s("div",{id:"js_range_slider",class:"col-lg-12"},[s("div",{class:"seperator-header"},[s("h4",{class:""}," Javascript Range Slider ")])],-1)),s("div",Ms,[s("div",Ls,[n[45]||(n[45]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Postion : Top-Left")])])],-1)),s("div",js,[s("div",Hs,[s("div",Ps,[s("span",Rs,l(C.value),1),n[42]||(n[42]=r()),n[43]||(n[43]=s("span",{class:"range-count-unit"},"%",-1))]),_(s("input",{"onUpdate:modelValue":n[8]||(n[8]=o=>C.value=o),type:"range",min:0,max:100,class:"progress-range-counter form-range"},null,512),[[y,C.value]])]),s("div",Js,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[9]||(n[9]=o=>u("code5"))},n[44]||(n[44]=[s("span",null,"Code",-1)])),d.value.includes("code5")?(i(),c("div",Is,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Top-Left -->
...
`,1)]),_:1})])):p("",!0)])])])]),s("div",Os,[s("div",Ys,[n[49]||(n[49]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Postion : Top-Right")])])],-1)),s("div",As,[s("div",Ws,[s("div",Es,[s("span",Gs,l(V.value),1),n[46]||(n[46]=r()),n[47]||(n[47]=s("span",{class:"range-count-unit"},"%",-1))]),_(s("input",{"onUpdate:modelValue":n[10]||(n[10]=o=>V.value=o),type:"range",min:0,max:100,class:"progress-range-counter form-range"},null,512),[[y,V.value]])]),s("div",qs,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[11]||(n[11]=o=>u("code6"))},n[48]||(n[48]=[s("span",null,"Code",-1)])),d.value.includes("code6")?(i(),c("div",zs,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Top-Right -->
...
`,1)]),_:1})])):p("",!0)])])])]),s("div",Ks,[s("div",Qs,[n[53]||(n[53]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Postion : Bottom-Left")])])],-1)),s("div",Xs,[s("div",Zs,[_(s("input",{"onUpdate:modelValue":n[12]||(n[12]=o=>U.value=o),type:"range",min:0,max:100,class:"progress-range-counter form-range"},null,512),[[y,U.value]]),s("div",sn,[s("span",nn,l(U.value),1),n[50]||(n[50]=r()),n[51]||(n[51]=s("span",{class:"range-count-unit"},"%",-1))])]),s("div",on,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[13]||(n[13]=o=>u("code7"))},n[52]||(n[52]=[s("span",null,"Code",-1)])),d.value.includes("code7")?(i(),c("div",en,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Bottom-Left -->
...
`,1)]),_:1})])):p("",!0)])])])]),s("div",Un,[s("div",Tn,[n[64]||(n[64]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",{class:"mb-4"}," Non linear slider ")])])],-1)),s("div",Fn,[s("div",$n,[a(F,{values:[w.value,k.value],config:{range:{min:[0],"10%":[500,500],"50%":[4e3,1e3],max:[1e4]},connect:!0,tooltips:!0,behaviour:"tap"},start:[w.value,k.value],"onUpdate:values":Y},null,8,["values","start"]),n[62]||(n[62]=s("br",null,null,-1)),s("div",Nn,[s("div",Sn,[s("span",Bn,[r(l(w.value)+" ",1),s("span",Dn,l(S.value)+"%",1)])]),s("div",Mn,[s("span",Ln,[r(l(k.value)+" ",1),s("span",jn,l(B.value)+"%",1)])])])]),s("div",Hn,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[21]||(n[21]=o=>u("code10"))},n[63]||(n[63]=[s("span",null,"Code",-1)])),d.value.includes("code10")?(i(),c("div",Pn,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Non linear slider -->
<div class="container">
    <vue-nouislider
    ...
    <div class="row mt-4 mb-4">
        ...
        <div class="col-lg-6 text-end">
            <span class="example-val"
                >`+l(k.value)+' <span class="precentage-val">'+l(B.value)+`%</span></span
            >
        </div>
    </div>
</div>
`,1)]),_:1})])):p("",!0)])])])])])]),s("div",Rn,[s("div",Jn,[n[67]||(n[67]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",{class:"mb-4"}," Locking sliders together ")])])],-1)),s("div",In,[s("div",On,[s("div",Yn,[s("div",An,[a(F,{values:[f.value],config:{range:{min:50,max:100},animate:!1,tooltips:!0},start:[f.value],"onUpdate:values":A},null,8,["values","start"]),s("span",Wn,l(f.value),1)])]),n[65]||(n[65]=s("br",null,null,-1)),s("div",En,[s("div",Gn,[a(F,{values:[x.value],config:{range:{min:50,max:100},animate:!1,tooltips:!0},start:[x.value],"onUpdate:values":W},null,8,["values","start"]),s("span",qn,l(x.value),1)])]),s("div",zn,[s("div",Kn,[s("button",{type:"button",class:"btn btn-primary my-4 float-end",onClick:n[22]||(n[22]=o=>{h.value=!h.value,E()})},l(h.value?"unlock":"lock"),1)])])]),s("div",Qn,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[23]||(n[23]=o=>u("code11"))},n[66]||(n[66]=[s("span",null,"Code",-1)])),d.value.includes("code11")?(i(),c("div",Xn,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Locking sliders together -->
<div class="container">
    <div class="row mb-4">
