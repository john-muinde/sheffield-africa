/* empty css                     */import{_ as m}from"./highlight.eabdfaa4.js";import"./use-meta.0a28ef70.js";import{S as d,f as w,V as r,o,c as l,bJ as k,a as e,aL as x,m as h,c9 as C,h as n,k as b,e as g}from"./app-setting.23ccb41c.js";/* empty css                        */import"./_commonjsHelpers.f037b798.js";const B={class:"container markdown"},V={class:"container"},q={class:"nav sidenav"},A={class:"sidenav-content"},N={id:"basic",class:"row layout-spacing layout-top-spacing"},U={class:"col-lg-12"},j={class:"statbox panel box box-shadow"},D={class:"panel-body"},E={class:"code-section-container show-code"},L={key:0,class:"code-section text-start"},M={id:"autosaving",class:"row layout-spacing"},T={class:"col-lg-12"},Y={class:"statbox panel box box-shadow"},$={class:"panel-body"},I={class:"code-section-container show-code"},O={key:0,class:"code-section text-start"},H={__name:"markdown_editor",setup(S){const s=d([]),c=d(`# Basic Example
