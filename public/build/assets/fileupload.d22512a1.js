...
`,-1),ce={__name:"fileupload",setup(ee){const l=w([]);y(()=>{v(),new r("myFirstImage",{images:{baseImage:"/assets/images/file-preview.png",backgroundImage:""}}),new r("mySecondImage",{images:{baseImage:"/assets/images/file-preview.png",backgroundImage:""}})});const c=t=>{l.value.includes(t)?l.value=l.value.filter(s=>s!=t):l.value.push(t)},v=()=>{setTimeout(()=>{var t=[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));t.map(s=>new window.bootstrap.Tooltip(s))})};return(t,s)=>{const f=o("scroll-spy-active"),g=o("scroll-spy-link"),h=o("scroll-spy");return i(),a("div",k,[(i(),I(F,{to:"#breadcrumb"},[x])),e("div",M,[e("div",S,[_((i(),a("div",C,j)),[[f],[g]])]),A,_((i(),a("div",L,[e("div",T,[e("div",B,[D,e("div",N,[V,e("div",X,[e("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:s[0]||(s[0]=b=>c("code1"))},P),l.value.includes("code1")?(i(),a("div",W,[p(d,null,{default:u(()=>[$]),_:1})])):m("",!0)])])])]),e("div",H,[e("div",O,[q,e("div",Y,[z,e("div",G,[e("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:s[1]||(s[1]=b=>c("code2"))},K),l.value.includes("code2")?(i(),a("div",Q,[p(d,null,{default:u(()=>[R]),_:1})])):m("",!0)])])])])])),[[h]])])])}}};export{ce as default};
