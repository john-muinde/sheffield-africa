...
`,1)]),_:1})])):p("",!0)])])])]),s("div",Ys,[s("div",qs,[n[49]||(n[49]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Postion : Top-Right")])])],-1)),s("div",As,[s("div",Os,[s("div",zs,[s("span",Es,l(T.value),1),n[46]||(n[46]=r()),n[47]||(n[47]=s("span",{class:"range-count-unit"},"%",-1))]),_(s("input",{type:"range","onUpdate:modelValue":n[10]||(n[10]=o=>T.value=o),min:0,max:100,class:"progress-range-counter form-range"},null,512),[[y,T.value]])]),s("div",Xs,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[11]||(n[11]=o=>u("code6"))},n[48]||(n[48]=[s("span",null,"Code",-1)])),d.value.includes("code6")?(i(),c("div",Gs,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Top-Right -->
