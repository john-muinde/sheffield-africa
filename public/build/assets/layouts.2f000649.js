/* empty css                     */import{_ as a}from"./highlight.08b594cd.js";import{z as g,C as u,bo as t,bp as i,bT as h,bq as o,aB as x,B as b,c2 as n,j as c,bC as r,bw as d}from"./app-setting.86984eaf.js";/* empty css                        */import"./_commonjsHelpers.f037b798.js";const w={class:"container"},k={class:"container"},C={class:"nav sidenav"},F={class:"sidenav-content"},S={class:"row"},_={id:"flStackForm",class:"col-lg-12 layout-spacing layout-top-spacing"},P={class:"statbox panel box box-shadow"},E={class:"panel-body"},R={class:"code-section-container show-code"},A={key:0,class:"code-section text-start"},I={id:"flHorizontalForm",class:"col-lg-12 layout-spacing"},N={class:"statbox panel box box-shadow"},z={class:"panel-body"},H={class:"code-section-container show-code"},G={key:0,class:"code-section text-start"},U={id:"flRegistrationForm",class:"col-lg-12 layout-spacing"},B={class:"statbox panel box box-shadow"},$={class:"panel-body"},L={class:"code-section-container show-code"},j={key:0,class:"code-section text-start"},D={id:"flLoginForm",class:"col-lg-12 layout-spacing"},Z={class:"statbox panel box box-shadow"},q={class:"panel-body"},W={class:"code-section-container show-code"},J={key:0,class:"code-section text-start"},M={id:"flFormsGrid",class:"col-lg-12 layout-spacing"},T={class:"statbox panel box box-shadow"},V={class:"panel-body"},K={class:"code-section-container show-code"},O={key:0,class:"code-section text-start"},Q={id:"flInlineForm",class:"col-lg-12 layout-spacing"},X={class:"statbox panel box box-shadow"},Y={class:"panel-body"},oo={class:"code-section-container show-code"},so={key:0,class:"code-section text-start"},lo={id:"flAutoSizing",class:"col-lg-12 layout-spacing"},to={class:"statbox panel box box-shadow"},io={class:"panel-body"},no={class:"code-section-container show-code"},eo={key:0,class:"code-section text-start"},ao={id:"flActionButtons",class:"col-lg-12"},co={class:"statbox panel box box-shadow"},ro={class:"panel-body"},mo={class:"code-section-container show-code"},po={key:0,class:"code-section text-start"},ho={__name:"layouts",setup(uo){const l=g([]),e=p=>{l.value.includes(p)?l.value=l.value.filter(s=>s!=p):l.value.push(p)};return(p,s)=>{const v=u("scroll-spy-active"),f=u("scroll-spy-link"),y=u("scroll-spy");return t(),i("div",w,[(t(),h(x,{to:"#breadcrumb"},[s[8]||(s[8]=o("ul",{class:"navbar-nav flex-row"},[o("li",null,[o("div",{class:"page-header"},[o("nav",{class:"breadcrumb-one","aria-label":"breadcrumb"},[o("ol",{class:"breadcrumb"},[o("li",{class:"breadcrumb-item"},[o("a",{href:"javascript:;"},"Forms")]),o("li",{class:"breadcrumb-item active","aria-current":"page"},[o("span",null,"Layouts")])])])])])],-1))])),o("div",k,[o("div",C,[b((t(),i("div",F,s[9]||(s[9]=[n('<a href="#flStackForm" class="nav-link">Stack Forms</a><a href="#flHorizontalForm" class="nav-link">Horizontal form</a><a href="#flRegistrationForm" class="nav-link">Registration Forms</a><a href="#flLoginForm" class="nav-link">Login Form</a><a href="#flFormsGrid" class="nav-link">Forms Grid</a><a href="#flInlineForm" class="nav-link">Inline forms</a><a href="#flAutoSizing" class="nav-link">Auto-sizing</a><a href="#flActionButtons" class="nav-link">Actions Buttons</a>',8)]))),[[v],[f]])]),s[42]||(s[42]=n('<div class="row layout-top-spacing"><div class="col-12"><div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg> Documentation: <a target="_blank" href="https://getbootstrap.com/docs/5.0/forms/layout" class="text-info"> https://getbootstrap.com/docs/5.0/forms/layout </a></div></div></div>',1)),b((t(),i("div",S,[o("div",_,[o("div",P,[s[13]||(s[13]=o("div",{class:"panel-heading"},[o("div",{class:"row"},[o("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[o("h4",null,"Stack Forms")])])],-1)),o("div",E,[s[12]||(s[12]=n('<form><div class="form-group mb-3"><input type="email" class="form-control" id="sEmail" aria-describedby="emailHelp1" placeholder="Email address"><small id="emailHelp1" class="block text-muted">We&#39;ll never share your email with anyone else.</small></div><div class="form-group"><input type="password" class="form-control" id="sPassword" placeholder="Password"></div><div><div class="custom-control custom-checkbox checkbox-primary"><input type="checkbox" class="custom-control-input" id="sChkbox"><label class="custom-control-label" for="sChkbox">Subscribe to weekly newsletter</label></div></div><button type="submit" class="btn btn-primary mt-4">Submit</button></form>',1)),o("div",R,[o("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:s[0]||(s[0]=m=>e("code1"))},s[10]||(s[10]=[o("span",null,"Code",-1)])),l.value.includes("code1")?(t(),i("div",A,[c(a,null,{default:r(()=>s[11]||(s[11]=[o("pre",null,`<!-- Stack Forms -->
<form>
