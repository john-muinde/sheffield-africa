import{q as t,s as Q,f as W,a7 as M,o as i,c,P as X,a as s,ar as ss,m as _,$ as Y,h as a,Z as $,k as v,e as p,l as r,t as l,Y as y,F as ns,g as os,am as es}from"./app-setting.597c09ad.js";/* empty css                     */import{_ as m}from"./highlight.6d4199b5.js";import{f as B}from"./custom-flatpickr.b38ec392.js";import"./_commonjsHelpers.f037b798.js";/* empty css                        */const ls={class:"container"},ts={class:"container"},as={class:"nav sidenav"},is={class:"sidenav-content"},ds={class:"row"},cs={class:"col-lg-12 col-12 layout-spacing"},rs={class:"statbox panel box box-shadow"},us={class:"panel-body"},vs={class:"form-group mb-0"},ps={class:"code-section-container show-code"},ms={key:0,class:"code-section text-start"},gs={class:"col-lg-12 col-12 layout-spacing"},bs={class:"statbox panel box box-shadow"},_s={class:"panel-body"},fs={class:"form-group mb-0"},xs={class:"code-section-container show-code"},ws={key:0,class:"code-section text-start"},ks={class:"col-lg-12 col-12 layout-spacing"},hs={class:"statbox panel box box-shadow"},ys={class:"panel-body"},Cs={class:"form-group mb-0"},Vs={class:"code-section-container show-code"},Ts={key:0,class:"code-section text-start"},Us={class:"col-lg-12 col-12 layout-spacing"},Fs={class:"statbox panel box box-shadow"},$s={class:"panel-body"},Bs={class:"form-group mb-0"},Ns={class:"code-section-container show-code"},Ss={key:0,class:"code-section text-start"},Ds={class:"row"},Ps={class:"col-lg-12 col-12 layout-spacing"},Ms={class:"statbox panel box box-shadow"},js={class:"panel-body"},Ls={class:"custom-progress progress-up",style:{width:"100%"}},Rs={class:"range-count"},Hs={class:"range-count-number"},Js={class:"code-section-container show-code"},Ys={key:0,class:"code-section text-start"},Is={class:"col-lg-12 col-12 layout-spacing"},As={class:"statbox panel box box-shadow"},Os={class:"panel-body"},qs={class:"custom-progress top-right progress-up",style:{width:"100%"}},Es={class:"range-count"},Zs={class:"range-count-number"},zs={class:"code-section-container show-code"},Gs={key:0,class:"code-section text-start"},Ks={class:"col-lg-12 col-12 layout-spacing"},Qs={class:"statbox panel box box-shadow"},Ws={class:"panel-body"},Xs={class:"custom-progress progress-down",style:{width:"100%"}},sn={class:"range-count"},nn={class:"range-count-number"},on={class:"code-section-container show-code"},en={key:0,class:"code-section text-start"},ln={class:"col-lg-12 col-12 layout-spacing"},tn={class:"statbox panel box box-shadow"},an={class:"panel-body"},dn={class:"custom-progress bottom-right progress-down",style:{width:"100%"}},cn={class:"range-count"},rn={class:"range-count-number"},un={class:"code-section-container show-code"},vn={key:0,class:"code-section text-start"},pn={class:"row"},mn={class:"col-lg-12 layout-spacing"},gn={class:"row"},bn={class:"col-lg-12 mb-4"},_n={class:"statbox panel box box-shadow"},fn={class:"panel-body align-center"},xn={class:"container"},wn={class:"row mt-4 mb-4"},kn={class:"col-lg-6 mb-3"},hn=["value"],yn={class:"col-lg-6"},Cn={class:"code-section-container show-code"},Vn={key:0,class:"code-section text-start"},Tn={class:"col-lg-12"},Un={class:"statbox panel box box-shadow"},Fn={class:"panel-body align-center"},$n={class:"container"},Bn={class:"row mt-4 mb-4"},Nn={class:"col-lg-6"},Sn={class:"example-val"},Dn={class:"precentage-val"},Pn={class:"col-lg-6 text-end"},Mn={class:"example-val"},jn={class:"precentage-val"},Ln={class:"code-section-container show-code"},Rn={key:0,class:"code-section text-start"},Hn={class:"col-lg-12 layout-spacing"},Jn={class:"statbox panel box box-shadow"},Yn={class:"panel-body align-center"},In={class:"container"},An={class:"row mb-4"},On={class:"col-lg-12 mb-5"},qn={class:"example-val mt-4 d-inline-block"},En={class:"row mb-0"},Zn={class:"col-lg-12 mb-5"},zn={class:"example-val mt-4 d-inline-block"},Gn={class:"row"},Kn={class:"col-lg-12"},Qn={class:"code-section-container show-code"},Wn={key:0,class:"code-section text-start"},ao={__name:"date_range_picker",setup(Xn){const d=t([]),j=t("2020-09-04"),L=t("2020-09-19 12:00"),R=t(""),H=t("13:45"),C=t(0),V=t(0),T=t(0),U=t(0),g=t(10),b=t(30),w=t(500),k=t(4e3),N=t(0),S=t(0),f=t(60),x=t(80),h=t(!1),D=t([60,80]);Q(()=>{P(g.value,b.value)});const u=e=>{d.value.includes(e)?d.value=d.value.filter(n=>n!=e):d.value.push(e)},P=(e,n)=>{g.value=parseInt(e),b.value=parseInt(n)},I=e=>{e&&(g.value=Math.round(parseFloat(e[0])),b.value=parseFloat(e[1]))},A=e=>{e&&(w.value=e[0],k.value=e[1],N.value=parseFloat((w.value*.01).toFixed(2)),S.value=parseFloat((k.value*.01).toFixed(2)))},O=e=>{e&&(f.value=parseFloat(e[0]),Z())},q=e=>{e&&(x.value=parseFloat(e[0]))},E=()=>{D.value=[Number(f.value),Number(x.value)]},Z=()=>{if(h.value){let e=JSON.parse(JSON.stringify(f.value));e-=D.value[0]-D.value[1],x.value=parseFloat(e.toFixed(2))}};return(e,n)=>{const F=W("vue-nouislider"),z=M("scroll-spy-active"),G=M("scroll-spy-link"),K=M("scroll-spy");return i(),c("div",ls,[(i(),X(ss,{to:"#breadcrumb"},[n[24]||(n[24]=s("ul",{class:"navbar-nav flex-row"},[s("li",null,[s("div",{class:"page-header"},[s("nav",{class:"breadcrumb-one","aria-label":"breadcrumb"},[s("ol",{class:"breadcrumb"},[s("li",{class:"breadcrumb-item"},[s("a",{href:"javascript:;"},"Forms")]),s("li",{class:"breadcrumb-item active","aria-current":"page"},[s("span",null,"Date and Range Picker")])])])])])],-1))])),s("div",ts,[s("div",as,[_((i(),c("div",is,n[25]||(n[25]=[s("a",{href:"#date_time_picker",class:"nav-link"},"Date Time Picker",-1),s("a",{href:"#js_range_slider",class:"nav-link"},"JS Range Slider",-1),s("a",{href:"#noUi_sliders",class:"nav-link"},"noUi Sliders",-1)]))),[[z],[G]])]),n[70]||(n[70]=Y('<div class="row layout-top-spacing"><div class="col-12"><div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg> Documentation: <a target="_blank" href="https://www.npmjs.com/package/vue-flatpickr-component" class="text-info"> https://www.npmjs.com/package/vue-flatpickr-component </a></div></div></div>',1)),_((i(),c("div",null,[s("div",ds,[n[41]||(n[41]=s("div",{id:"date_time_picker",class:"col-lg-12 layout-top-spacing"},[s("div",{class:"seperator-header"},[s("h4",{class:""},"Date and Time Picker")])],-1)),s("div",cs,[s("div",rs,[n[28]||(n[28]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Basic")])])],-1)),s("div",us,[s("div",vs,[a($(B),{modelValue:j.value,"onUpdate:modelValue":n[0]||(n[0]=o=>j.value=o),class:"form-control flatpickr active"},null,8,["modelValue"])]),s("div",ps,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[1]||(n[1]=o=>u("code1"))},n[26]||(n[26]=[s("span",null,"Code",-1)])),d.value.includes("code1")?(i(),c("div",ms,[a(m,null,{default:v(()=>n[27]||(n[27]=[s("pre",null,`<!-- Basic -->
...
`,-1)])),_:1})])):p("",!0)])])])])]),s("div",Ds,[n[58]||(n[58]=s("div",{id:"js_range_slider",class:"col-lg-12"},[s("div",{class:"seperator-header"},[s("h4",{class:""},"Javascript Range Slider")])],-1)),s("div",Ps,[s("div",Ms,[n[45]||(n[45]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Postion : Top-Left")])])],-1)),s("div",js,[s("div",Ls,[s("div",Rs,[s("span",Hs,l(C.value),1),n[42]||(n[42]=r()),n[43]||(n[43]=s("span",{class:"range-count-unit"},"%",-1))]),_(s("input",{type:"range","onUpdate:modelValue":n[8]||(n[8]=o=>C.value=o),min:0,max:100,class:"progress-range-counter form-range"},null,512),[[y,C.value]])]),s("div",Js,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[9]||(n[9]=o=>u("code5"))},n[44]||(n[44]=[s("span",null,"Code",-1)])),d.value.includes("code5")?(i(),c("div",Ys,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Top-Left -->
...
`,1)]),_:1})])):p("",!0)])])])]),s("div",Is,[s("div",As,[n[49]||(n[49]=s("div",{class:"panel-heading"},[s("div",{class:"row"},[s("div",{class:"col-xl-12 col-md-12 col-sm-12 col-12"},[s("h4",null,"Postion : Top-Right")])])],-1)),s("div",Os,[s("div",qs,[s("div",Es,[s("span",Zs,l(V.value),1),n[46]||(n[46]=r()),n[47]||(n[47]=s("span",{class:"range-count-unit"},"%",-1))]),_(s("input",{type:"range","onUpdate:modelValue":n[10]||(n[10]=o=>V.value=o),min:0,max:100,class:"progress-range-counter form-range"},null,512),[[y,V.value]])]),s("div",zs,[s("button",{type:"button",class:"btn btn-default toggle-code-snippet",onClick:n[11]||(n[11]=o=>u("code6"))},n[48]||(n[48]=[s("span",null,"Code",-1)])),d.value.includes("code6")?(i(),c("div",Gs,[a(m,null,{default:v(()=>[s("pre",null,`<!-- Top-Right -->
