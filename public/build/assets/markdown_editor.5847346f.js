/* empty css                     */import{_ as m}from"./highlight.5e96ede6.js";import{s as d,f as w,a5 as r,o,c as l,a0 as k,a as e,ap as x,p as h,X as C,i as n,l as b,e as g}from"./app-setting.32868441.js";/* empty css                        */import"./_commonjsHelpers.f037b798.js";const B={class:"container markdown"},V={class:"container"},q={class:"nav sidenav"},A={class:"sidenav-content"},N={id:"basic",class:"row layout-spacing layout-top-spacing"},U={class:"col-lg-12"},j={class:"statbox panel box box-shadow"},D={class:"panel-body"},E={class:"code-section-container show-code"},M={key:0,class:"code-section text-start"},L={id:"autosaving",class:"row layout-spacing"},T={class:"col-lg-12"},Y={class:"statbox panel box box-shadow"},$={class:"panel-body"},I={class:"code-section-container show-code"},O={key:0,class:"code-section text-start"},z={__name:"markdown_editor",setup(W){const s=d([]),c=d(`# Basic Example
