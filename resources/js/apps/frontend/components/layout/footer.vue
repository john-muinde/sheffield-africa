        ...
        <footer class="footer mt-5">
            ...
            >
                <div class="container-fluid">
                    <div class="row mt-3">
                        <div
                            class="col-xl-12 justify-content-center footer-banner mb-1"
                        >
                            <span
                                class="cta-title cta-title-footer text-primary"
                                >SHEFFIELD STEEL SYSTEMS LIMITED</span
                            >
                        </div>
                                ...
                                <ul class="mt-1 mb-2">
                                    <li class="my-footer-li">
                                        <img
                                            ...
                                            alt="Icon 1"
                                        />
                                        Off Old Mombasa Road before the Nairobi
                                ...
                                <ul class="mt-1 mb-2">
                                    <li class="my-footer-li">
                                        <img
                                            ...
                                            alt="Icon 1"
                                        />
                                        Petrocity Complex 1st Floor-Off Links
                                        Road, Nyali, Mombasa
                                    </li>
                                ...
                                <ul class="mt-1 mb-2">
                                    <li class="my-footer-li">
                                        <img
                                            ...
                                            alt="Icon 1"
                                        />
                                        Bugalobi Hardware City Opposite Uganda
                                        Baati, Block 3 Room 102, Mulwana Road.
                                    </li>
                                    <!-- <li class="my-footer-li">
                      ...
                      P. O. Box 29 – 00606, Nairobi Kenya
                                    ...
                                    <li class="my-footer-li">
                                        ...
                                        />
                                        <a
                                            href="mailto:sales@sheffieldafrica.com"
                                        >
                            ...
                            <div class="footer-contacts">
                                ...
                                <ul class="mt-1 mb-2">
                                    ...
                                    <li class="my-footer-li">
                                        ...
                                        />
                                        <a
                                            href="mailto:sales1rwanda@sheffieldafrica.com"
                                        >
                        ...
                        >
                            ...
                            <router-link
                                to="/contact-us"
                                class="btn btn-primary btn-footer ml-5"
                                style="border: solid 2px"
                        ...
                        <div class="col-sm-4 col-lg-3">
                            <div class="widget widget-about">
                                ...
                                <div class="social-icons">
                                    ...
                                    >
                                        <img
                                            src="/assets/images/social-icons/x.png"
                                        />
                                    </a>
                                    <a
                        ...
                        <div class="col-sm-4 col-lg-3">
                            <div class="widget">
                                ...
                                <ul class="widget-list">
                                    ...
                                    <li class="ec-footer-link">
                                        <router-link to="/warranty-terms">
                                            Warranty Terms
                                        </router-link>
                                    </li>

                                    <li class="ec-footer-link">
                                        <router-link to="/lease-and-finance"
                                            >Lease & Finance</router-link
                                        >
                                    </li>
                                </ul>
                                <!-- End .widget-list -->
            ...
            <div class="footer-bottom">
                <div class="container-fluid justify-content-center">
                    <p class="footer-copyright">
                        ...
                        <b>Sheffield Africa</b>. All Rights Reserved.
                    </p>
...
.social-icon:hover img {
    filter: invert(99%) sepia(0%) saturate(2%) hue-rotate(132deg)
