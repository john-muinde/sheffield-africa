    ...
    >
      ...
      >
        ...
        >
          <div class="sf-with-ul">
            <p class="category">
              <img class="mobile-menu-icon" :src="`/assets/images/menu-icons/${formattedName(category.name)}.png`" /> {{ category.name }}
            </p>
          </div>
        </router-link>
      </li>
      ...
      >
        ...
        >
          <div class="sf-with-ul">
            <p class="category">
              <img class="mobile-menu-icon" src="/assets/images/menu-icons/consultancy-design.png" /> Consultancy & Design
            </p>
          </div>
        </router-link>
      </li>
...
.box3 {
    border: 3.5px dotted #7ab337 !important;
}
