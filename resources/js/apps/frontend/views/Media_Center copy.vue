                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1 mb-5">
                            ...
                            <h2 class="about-us-title">Media Center</h2><!-- End .title -->
                            <p class="lead about-us-lead text-primary mb-1">Immerse Yourself in our Media Showcase</p>
                ...
                <div class="container bg-my-grey">
                        ...
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <div class="row media-center">
                                ...
                                <div class="col-lg-12 mt-4">
                                    ...
                                    <p class="lead about-us-lead text-primary mb-2"><router-link to="/media/blogs">Blogs</router-link>

                                         <router-link style="right: 0; position: absolute;" class="btn btn-primary pull-right" to="/media/blogs">View More Blogs</router-link>
                                    ...
                                    <section class="position-relative overflow-hidden py-20">
                                      ...
                                      <div class="container">
                                        ...
                                        <div class="row mb-10">
                                          ...
                                          <div class="col-12 col-md-6 col-lg-3 mb-2 blog-item" v-for="blog in blogs" :key="blog.id">
                                            <div class="p-6 border rounded">
                                              <div class="position-relative mb-2" style="height: 216px;">

                                                <router-link :to="getBlogLink(blog.id, blog.name)">
                                                   <img class="w-100 h-100 rounded" style="object-fit: cover;" :src="'/storage/' + blog.main_image_path" :alt="blog.name">
                                                </router-link>
                                              ...
                                              <p class="mb-1 text-muted px-4 entry-content">{{ getFirstParagraph(blog.content) }}</p>
                 ...
                 <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1">
                            <div class="row media-center">
                                <div class="col-lg-12 mt-2" id="brochures-and-newsletters">

                                    <p class="lead about-us-lead text-primary mb-0"><router-link to="/media#brochures-and-newsletters">Brochures & Newsletters</router-link></p>
                                ...
                                <div class="col-lg-12 mt-2" id="videos">

                                    <p class="lead about-us-lead text-primary mb-0"><router-link to="/media#videos">Videos</router-link></p>

                                    <div class="row">

                                        <div class="col-lg-4 mt-2"  v-for="video in videos" :key="video.id">

                                            <div style="background-color: #000; height: 100%">

                                            <video style="width:100%; height: 100%;" controls :src="'/storage/' + video.file_path" type="video/mp4" >
