                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <h2 class="about-us-title"> Newsletters </h2><!-- End .title -->
                            ...
                            <p class="lead about-us-lead text-primary mb-1">Explore Our Newsletters</p>
                                    ...
                                    <div class="widget widget-cats">
                                       ...
                                       <!--  <h3 class="widget-title"><b>Newsletters</b></h3> -->
                                        ...
                                        <ul class="ul-pdf-view-documents">
                                          <li v-for="brochure in newsletters" :key="brochure.id"  @click="loadDocument('/storage/' + brochure.publication_file, brochure.id)">
