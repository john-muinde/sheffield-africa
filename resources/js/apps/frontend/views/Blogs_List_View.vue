                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <h2 class="about-us-title">Blogs</h2><!-- End .title -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 blogs">
                                    ...
                                    <article class="entry entry-list" v-for="product in displayedProducts" :key="product.id">
                                            ...
                                            <div class="col-md-7">
                                                <div class="entry-body">
                                                    ...
                                                    <div class="entry-content">
                                                        <div class="mb-2">
                                                         {{ getFirstParagraph(product.content) }}
                                                     </div>


                                                         <router-link class="btn btn-primary" :to="getBlogLink(product.id, product.name)">
