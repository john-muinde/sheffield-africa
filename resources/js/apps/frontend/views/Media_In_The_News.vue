                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1 in-the-news-section">
                            ...
                            <h2 class="about-us-title">In the News</h2><!-- End .title -->
                            ...
                            <p class="lead about-us-lead text-primary mb-3">Media Spotlight: Sheffield Making Waves in the News</p>

                            <div class="row justify-content-left">

                                <div class="col-12 col-md-6 col-lg-4 mb-2 blog-item" v-for="product in displayedProducts" :key="product.id">
                                    <div class="p-6 border rounded">
                                      <div class="position-relative mb-2" style="height: 216px;">

                                        <a target="_blank" class="  float-center" :href="product.url">
                                           <img class="w-100 h-100 rounded" style="object-fit: cover;" :src="'/storage/' + product.main_image_path" :alt="product.name">
                                        </a>
                                      ...
                                      <a target="_blank" class="btn btn-primary ml-5 pl-4 mt-2 mb-2 float-center" :href="product.url">
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination justify-content-center">
                                          <li class="page-item" :class="{ disabled: currentPage === 1 }">
                                            <router-link class="page-link page-link-prev" :to="getBlogPageLink(currentPage - 1 )" aria-label="Previous" tabindex="-1" aria-disabled="true" @click="goToPreviousPage">
                                          ...
                                          <li class="page-item" v-for="page in generatePageLinks" :key="page" :class="{ active: page === currentPage }">
                                            ...
                                            <template v-if="isInteger(page)">
                                              <router-link class="page-link" :to="getBlogPageLink( page )" @click="goToThisPage(page)">
                                                {{ page }}
                                              </router-link>
                                            </template>
                                          ...
                                          <li class="page-item" :class="{ disabled: currentPage === totalPages }">
                                            <router-link class="page-link page-link-next" :to="getBlogPageLink(currentPage + 1 )" aria-label="Next" @click="goToNextPage">
                                              Next
...
const route = useRoute()
 ...
 const getBlogLink = (id, name) => {
    ...
    return `/media/in-the-news/${id}/${transformedName}`;
 };
