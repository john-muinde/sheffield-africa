                                ...
                                <div
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input v-model="contact.firstname" type="text" class="form-control"
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input v-model="contact.surname" type="text" class="form-control"
                                                id="surname" name="surname" placeholder="Please enter your surname"
                                                required />
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-group">
                                                <div style="max-width: 35%; width: 35%" class="input-group-prepend">
                                                    <select required class="form-control" name="code"
                                                ...
                                                <input style="width: 65%" v-model="contact.phone_number" type="text"
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input v-model="contact.company_name" type="company_name"
                                                class="form-control" id="company_name" name="company_name"
                                                placeholder="Please enter your company name" required />
                                        </div>

                                        <div class="col-sm-12">
                                            <label for="country" class="label-contact">Country *</label>

                                            <select v-model="contact.country" name="country" id="country"
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea v-model="contact.location" class="form-control" cols="30" rows="4"
                                    ...
                                    <div class="summary summary-cart">
                                        ...
                                        <table class="table table-summary">
                                            <tbody>
                                                <tr class="summary-shipping">
                                                    <td colspan="2">
                                                        <h3 class="summary-title text-left">Selected Products</h3>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table table-summary">
                                            <tbody>
                                                ...
                                                <tr class="summary-shipping">
                                                    <td colspan="2">
                                                        <h3 class="summary-title text-left mt-2">Shipping</h3>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="summary-shipping">
                                                    <td width="100%" style="min-width: 100%; width: 100%">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="deliver" name="shipping"
                                                                v-model="contact.shipping" class="custom-control-input"
                                                                value="Deliver to my location" required />
                                                            <label style="font-size: 1.4rem; font-weight: 450"
                                                                class="custom-control-label float-left text-dark"
                                                                for="deliver">Deliver to my location</label>
                                                        </div>
                                                        <!-- End .custom-control -->
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="">
                                                    <td style="min-width: 100%; width: 100%">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="collect_from_sheffield"
                                                                name="shipping" v-model="contact.shipping"
                                                                class="custom-control-input"
                                                                value="Collect from Sheffield" required />
                                                            <label style="font-size: 1.4rem; font-weight: 450"
                                                                class="custom-control-label float-left text-dark"
                                                                for="collect_from_sheffield">Collect from Sheffield
                                                            </label>
                                                        </div>
                                                        <!-- End .custom-control -->
                                                    </td>
                                                ...
                                                <tr class="summary-shipping">
                                                    <td colspan="2">
                                                        <h3 class="summary-title text-left mt-2">Installation</h3>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="summary-shipping">
                                                    <td width="100%" style="min-width: 100%; width: 100%">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="installation_yes"
                                                                name="installation" v-model="contact.installation"
                                                                class="custom-control-input" value="Yes" required />
                                                            <label style="font-size: 1.4rem; font-weight: 450"
                                                                class="custom-control-label float-left text-dark"
                                                                for="installation_yes">Yes</label>
                                                        </div>
                                                        <!-- End .custom-control -->
                                                    </td>
                                                </tr>
...
const { storeContact, validationErrors, isLoading } = useRequestQuotes();
