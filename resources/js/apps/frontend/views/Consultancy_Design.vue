                  ...
                  <div class="row">
                    <div class="col-lg-7 who-we-are">
                      ...
                      <p class="who-we-are-p">
                        Sheffield offers Design & Consultancy which entails our
                        comprehensive expert guidance and services related to the
                        planning, design, and optimization of your facility spaces in the
                        scope of Food Service, Laundry, Cold Storage, and Civil & MEP
                        Works.This will include the following:
                      </p>

                      <br />

                      <h5 class="mt-2 sub-title-cd">
                        Advantages of Sheffield Consultancy
                      </h5>

                      <p class="who-we-are-p">
                        The advantages of Sheffield Consultancy encompass a comprehensive
                        range of factors, ensuring a seamless and efficient project
                        execution:
                      </p>

                      <ul class="graduate-trainee-program mb-3 mt-3">
                        <li>
                          <span class="badge badge-secondary">1</span>
                          <span class="li-text">
                            <strong>Correct Flow of Production:</strong>
                            Ensuring a smooth and logical flow from the receiving area to
                            food service, optimizing the production process.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Accurate Space Area Allocations and Design:</strong>
                            Precise planning of space allocations and design, maximizing
                            the functionality and usability of the available area.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Right Equipment Selection:</strong>
                            Expertise in selecting the most suitable and efficient
                            equipment for the specific needs of the project.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Efficient Space Utilization:</strong>
                            Maximizing the utilization of space, machinery, and various
                            facilities within the project to enhance operational
                            efficiency.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Choice of Durable and Hygienic Surroundings:</strong>
                            Selection of durable and hygiene-safe materials for commercial
                            settings, including considerations for floor, wall, ceiling
                            finishes, lighting, water and drain systems, as well as
                            addressing issues like grease, smell, and waste management.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Ventilation, LPG, and Power Requirements:</strong>
                            Addressing and optimizing ventilation needs, LPG requirements,
                            and power specifications to ensure a safe and functional
                            environment.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Budget Costing:</strong>
                            Providing accurate budget estimations for the project,
                            ensuring financial transparency and effective cost management.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Tender Specifications:</strong>
                            Preparing detailed tender specifications that articulate
                            project requirements clearly and comprehensively.
                          </span>
                        </li>
                        ...
                        <li>
                          ...
                          <span class="li-text">
                            <strong>Timelining of Project Execution:</strong>
                            Developing a well-structured timeline for the execution of the
                            project, ensuring timely completion and delivery.
                          </span>
                        </li>
                      </ul>
                    ...
                    <div class="col-lg-5 consultancy-and-design-image">
                      <div class="">
                        <img
                          style="margin-left: 0%; margin-top: 20%"
                          src="/assets/images/consultancy-and-design.jpg"
                          alt=""
                          class=""
                        />
...
.graduate-trainee-program .badge {
  position: absolute;
  font-size: 1.5rem;
  border-radius: 50%;
  width: 25px;
...
.graduate-trainee-program .li-text {
  margin-left: 35px;
}
