              ...
              <ul style="margin-left: 20px;" class="mt-2" >
                ...
                <li>
                  ...
                  <ol style="list-style-type: lower-alpha; margin-left: 30px;">
                    ...
                    <li>In case of delays on collection we can deviate goods to other clients and a fresh delivery date will be agreed on.</li>
                    <li>We are dedicated to promptly fulfill your order with the best solution possible. We will supply the quoted or available equivalent model from our stock at the time the order is placed, ensuring it meets your requirements and expectations.</li>
                    <li>A client is advised to come for an inspection after the fabrication of goods to confirm the quantity and quality of equipment.</li>
                    <li>In case any adjustments need to be done, then this is the best time since it might be difficult to adjust at the site during installation.</li>
                ...
                <li>
                  ...
                  <ol style="list-style-type: lower-alpha; margin-left: 30px;">
                    <li>Date of start of work will be from the date of receipt of advance payment, L.P.O, and Sheffield contract.</li>
                    <li>After inspection of products it can take one (1) to two (2) weeks for any corrective work required or pointed out by customers.</li>
                    <li>Packing will require one (1) to three (3) business days based on the scope of work.</li>
                  ...
                  <ol style="list-style-type: lower-alpha; margin-left: 30px;">
                    ...
                    <li>For optimum working of machines it is essential that the supply of other services are of the required specifications:
                      ...
                      <ol style="list-style-type: lower-roman; margin-left: 30px;">
                        ...
                        <li>The drain should be the right size and right position.</li>
                        <li>Gas should be of the right size and right pressure.</li>
                        <li>Electrical supply should have stabilized and safety from phase failure, single phasing, and short circuits.</li>
                    ...
                    <li>All structural stainless steel fabrication work will be under warranty for 2 years.</li>
                    <li>All gas installation will be under warranty for 1 year.</li>
                    <li>All refrigeration installations will be under warranty for 6 months.</li>
                    <li>Electrical fittings do not carry any warranty because we don’t have the control over quality of the power supply. Goods quoted are of high quality and can last for very long if power guards are fitted to take care of voltage spikes and phase failure are installed.</li>
                    <li>Warranty period applies from the date of delivery.</li>
                    <li>Warranty does not cover the cost of transport, food, or accommodation. It only covers the cost of the replacement of spare parts without any charge.</li>
                    <li>Warranty terms are not applicable for damages caused by negligent use, unauthorized repairs carried out by others, wear and tear, faulty supply of gas, water, or power, etc.</li>
                    <li>Only our technicians should be authorized to carry out service and repairs to validate the warranty.</li>
                    <li>Warranty terms apply only if the full cost of equipment has been paid to us. We cannot undertake repair and maintenance if the equipment has not been paid for in full.</li>
                    <li>We shall either replace the malfunctioning spare parts or refund the cost of spare parts. The client cannot claim other consequential damages like loss of business, profits, etc.</li>
                    <li>Rational carries a 2-year warranty if Sheffield installs the machines.</li>
                    <li>Repair and maintenance under guarantee will be carried out during work hours i.e. between 8.00 am and 6.00 pm, from Monday to Saturday only.</li>
                    <li>Warranty cost out of Nairobi – Travel, Food, and accommodation of Engineer/Technician will be in the scope of the client.</li>
                    <li>Warranty claims will not be accepted without warranty certificate invoice reference.</li>
                    <li>Replacement of the spares does not extend or restart the warranty.</li>
                ...
                <li>
                  ...
                  <ol style="list-style-type: lower-alpha; margin-left: 30px;">
                    <li>Our site engineer will conduct a pre-installation inspection to confirm if the site is ready for installation. The installation period starts once we confirm that the site is ready for installation.</li>
                    <li>Client is responsible for finishing wet works, paints, tiling, electrical, water, drainage, and gas lines to the position and ratings specified for the equipment.</li>
                    <li>Client should provide a lockable secure place to store equipment and machinery during installation.</li>
                    <li>The client should arrange the necessary power supply, water, and drainage.</li>
                    <li>All terminal fittings i.e. isolators, status, water taps, drainage fittings should be supplied and fitted by the client and within 1.0 M distance from the location of the equipment to be installed.</li>
                    <li>Travels, Food, and accommodation for technicians, supervisors, and site managers to be arranged by the client during site visits, meetings, and installation. It is advised that the client arrange for suitable food and accommodation near the installation site so that installation can happen within a short period.</li>
                    <li>In case the site does not get ready in time or the power/water connection is not arranged in time, and we have to revisit to complete the remaining installation, the installation cost will be charged extra.</li>
                    <li>Installation is deemed complete once the goods are put into use by the client.</li>
                    <li>Installation of sinks, supply of water taps, terminal taps drain fittings, etc. have to be arranged by the customer.</li>
                    <li>Client will provide labor, and specialized machines (forklift/cranes) to offload and move equipment to kitchen positions.</li>
                    <li>Installations will only be carried out during work hours from 8.00 am to 5.00 pm from Monday to Saturday.</li>
                ...
                <li>
                  ...
                  <ol style="list-style-type: lower-alpha; margin-left: 30px;">
                    <li>We shall provide 2 free preventive maintenance services, ready at the end of two quarters after installation on turnkey projects.</li>
                    <li>After the free service we recommend that the client signs an Annual Maintenance Contract (AMC). This will prevent further breakdown of equipment and ensure that equipment continues to work and generate revenue.</li>
                    <li>We shall submit the details of AMC and the cost separately. We normally stock a healthy quantity of spare parts but if not available we airlift the same.</li>
                    <li>Having AMC ensures that spare parts are made available at the earliest.</li>
                ...
                <li>
                  ...
                  <ol style="list-style-type: lower-alpha; margin-left: 30px;">
                    ...
                    <li>Client to present the original receipt and invoice.</li>
