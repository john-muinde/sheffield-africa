      ...
      <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        ...
        <div class="page-content pb-0">
            ...
            <div class="row">
              <div class="col-lg-12 pt-3">
                  ...
                  <div  class="entry-container max-col-3">
                      <div class="entry-item lifestyle shopping col-sm-4" v-for="(image, index) in project.project_images" :key="index">
            ...
            <div class="stores mb-4 mb-lg-5">
              <h3 class="header text-primary text-left mb-3">Other projects</h3><!-- End .title text-center mb-2 -->

              <div class="row">

                 <div class="col-sm-6 col-lg-3" v-for="project in other_projects" :key="project.id">
