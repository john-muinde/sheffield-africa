          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-10 offset-lg-1">
                <h2 class="about-us-title">Contact Us</h2>
                <!-- End .title -->
              ...
              <div class="offset-lg-1 col-lg-5 mb-3 mb-lg-0 contact-form-div">
                ...
                >
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <label for="business_type" class="label-contact"
                        >Business Type *</label
                      >

                      <select
                        v-model="contact.business_type"
                        name="business_type"
                        id="business_type"
                        class="form-control"
                        required
                      >
                        ...
                        <option value="ARCHITECTS & ENGINEERS">
                        ...
                        <option value="RETAIL & SUPERMARKETS">
                          RETAIL & SUPERMARKETS
                        </option>
                    ...
                    <div class="col-sm-12">
                      <label for="request_type" class="label-contact"
                        >Request Type *</label
                      >

                      <select
                        v-model="contact.request_type"
                        name="request_type"
                        id="request_type"
                        class="form-control"
                        required
                      >
                        ...
                        <option value="Parts and Consumables">
                    ...
                    <div class="col-sm-12">
                      <label for="area_of_interest" class="label-contact"
                        >Area of Interest *</label
                      >

                      <select
                        v-model="contact.area_of_interest"
                      ...
                      >
                        <option value="">Select an option</option>
                        <option value="Food Service Equipment">
                          Food Service Equipment
                        </option>
                        <option value="Laundry and Floor Cleaning">
                    ...
                    <div class="col-lg-12">
                      <label for="request" class="label-contact">Request*</label>
                      <textarea
                        v-model="contact.request"
                        class="form-control"
                        cols="30"
                        rows="4"
                        id="request"
                        name="request"
                        required
                        placeholder="I'd like to find out more about your FOOD and LAUNDRY solutions, please get in touch with me."
                      ></textarea>
                    </div>
                    ...
                    <div class="col-lg-12 mt-2">
                      <label>
                        <input
                          type="checkbox"
                          v-model="contact.agree_to_marketing"
                          style="margin-right: 10px"
                        />
                        <span style="margin-left: 10px">
                          Yes, I agree to receive marketing communications regarding
                    ...
                    <div class="col-lg-12 mt-1">
                      <label>
                        <input
                          required
                          type="checkbox"
                          v-model="contact.accept_terms_conditions"
                          style="margin-right: 10px"
                        />
                        <span style="margin-left: 10px">
                  ...
                  type="submit"
                    :disabled="isLoading"
                    class="btn btn-primary btn-minwidth-sm mt-2"
                  >
              ...
              <div class="col-lg-5">
                <div class="contact-images about-images">
                  <img
                    src="../assets/images/about/contact_us_sheffield.jpg"
                    alt=""
                ...
                <div class="contact-us-block mt-2">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="contact-info">
                        <span class="contact_details_h3">Map</span>
                      </div>
                      <!-- End .contact-info -->
                    </div>
                    <!-- End .col-sm-7 -->
...
import useContacts from "@/composables/contact";
...
const { value: request_type } = useField("request_type", null, { initialValue: "" });
const { value: area_of_interest } = useField("area_of_interest", null, {
  initialValue: "",
});
...
const { value: business_type } = useField("business_type", null, { initialValue: "" });
const { value: country } = useField("country", null, { initialValue: "" });
const { value: request } = useField("request", null, { initialValue: "" });
const { value: code } = useField("code", null, { initialValue: "254" });

const { storeContact, validationErrors, isLoading } = useContacts();
