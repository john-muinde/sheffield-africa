                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1 gallery-main-page-section">
                            ...
                            <p class="lead about-us-lead text-primary mb-3">Journey Through the Lens: Our Story in Pictures</p>

                            <div class="row">

                         

                                <div class="entry-item col-sm-6 col-lg-4" v-for="product in displayedProducts" :key="product.id">
                                    <article class="entry entry-mask">
                                        <figure class="entry-media entry-gallery">
                                             <router-link :to="getBlogLink(product.id, product.name)">
                                                <img :src="'/storage/' + product.main_image_path" v-lazy:src="'/storage/' + product.main_image_path"  alt="image desc">
                                            </router-link>
                                        ...
                                        <div class="entry-body">
                                            ...
                                            <h2 class="entry-title">
                                                 <router-link :to="getBlogLink(product.id, product.name)">{{ product.name }}</router-link>
                                            </h2><!-- End .entry-title -->

                                            <div class="entry-cats mt-1">
                                                <b style="background-color:#c02434; padding: 5px;">{{ product.gallery_type }}</b>
                                            </div><!-- End .entry-cats -->
                                        </div><!-- End .entry-body -->
                                    </article><!-- End .entry -->
                                </div>
