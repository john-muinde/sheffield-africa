      ...
      <div class="container mx-auto px-4 max-w-full">
        ...
        <div class="max-w-full mx-auto">
          <Carousel
            ...
            @prev="onPrev"
          >
            <Slide v-for="(item, index) in projectsMenu" :key="index" class="px-2">
              <div
                ...
                :class="[
                  currentSlide === index ? '!bg-red-600 shadow-xl' : 'bg-white hover:bg-gray-50',
                ]"
                @click="slideTo(index)"
              >
                <div class="flex flex-col items-center space-y-4">
                  <img
                    ...
                    :class="[currentSlide === index ? 'brightness-0 invert' : 'filter-gray-scale']"
                  />
                  <div class="relative">
                    <span
                      class="text-lg font-semibold uppercase"
                      :class="[currentSlide === index ? 'text-white' : 'text-gray-700']"
                    >
                      {{ item.title }}
                    </span>
                    <div
