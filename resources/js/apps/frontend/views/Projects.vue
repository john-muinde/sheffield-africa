...
.entry-container {
  ...
  width: 100%; /* Adjust the gap between items as needed */
}
...
.entry-media img {
    transition: transform 2.3s; /* Add a smooth transition effect */
}

.entry-media img:hover {
    transform: scale(1.2); /* Zoom in the image by 20% on hover */
}
