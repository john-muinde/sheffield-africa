      ...
      <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ solutionCategories.name }}</li>
            </ol>
            ...
            <div class="row">
                  ...
                  <div class="products mb-3">
                     <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 mt-1">
                                ...
                                <div class="card-header" id="heading-2">
                                    <h2 class="card-title">
                                        ...
                                        <a class="collapsed" role="button" data-toggle="collapse" href="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
                                            {{ solutionCategories.name }} - SOLUTION
                                        </a>
                                    </h2>
                                </div><!-- End .card-header -->
                         ...
                         <div class="col-6 col-md-2 col-lg-2 col-xl-2 image-container" v-for="product in solutionCategoryProducts" :key="product.id">
               ...
               <aside class="col-lg-2 order-lg-first mt-2">
                  <div class="sidebar sidebar-shop sidebar-shop-solution">
                     ...
                     <div v-if="solutionCategoriesList.length" class="widget widget-collapsible widget-categories">
                        ...
                        <div class="collapse show" id="widget-1">
                           <div class="widget-body">
                              <div class="filter-items filter-items-count">
                                 ...
                                 <div class="filter-item" v-for="category in solutionCategoriesList" :key="category.id" >
                     ...
                     <div class="widget widget-collapsible">
                        ...
                        <div class="collapse show" id="widget-4">
                           <div class="widget-body">
                              <img :src="'/storage/' + solutionCategories.main_image_path" v-lazy:src="'/storage/' + solutionCategories.main_image_path" alt="Product image">
                              <!-- End .filter-items --> 
                           </div>
                           <!-- End .widget-body -->
                        </div>
...
<script setup>
  ...
  useMeta({ 
      ...
      description:"We offer state of the art commercial cold room equipment at Sheffield africa Ltd",
      keywords:"Cold room equipment"
   });
  ...
  const fetchSolutionCategoryProducts = async () => {
   ...
   const newCheckedCategoriesSolutions = {
     [solution_id.value]: checkedCategoriesSolutions.value[solution_id.value] || [], 
   };
