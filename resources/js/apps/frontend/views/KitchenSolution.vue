                  ...
                  <div class="products mb-3">
                     <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 mt-1">
                         ...
                         <div class="col-6 col-md-3 col-lg-2 col-xl-2 image-container" v-for="product in solutionCategoryProducts" :key="product.id">
...
<script setup>
  ...
  const fetchSolutionCategories = async () => {
    ...
    try {
      ...
      useMeta({ title: solutionCategories.value.name + " | Kitchen Solution" });
