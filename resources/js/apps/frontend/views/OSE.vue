            ...
            <div class="col-lg-12">
              ...
              <section id="heroing" class="">
                ...
                >
                  <div class="w-full md:w-1/2">
                    <span class="uppercase tracking-wider text-[#717171] text-base">Discover</span>
                    <h1
                      class="capitalize tracking-wide font-roboto font-black text-[clamp(2.5rem,3.25rem+0.75vw,4rem)] bg-gradient-to-r from-[#e82a3e] to-black bg-clip-text text-transparent"
                    >
                      Operating Supplies & Equipment
                    </h1>
                    <hr class="block bg-[#e82a3e] h-1 w-24 border-0 my-6 mx-0" />
                    <p class="text-[#999999] leading-relaxed">
                      Premium quality Operating Supplies & Equipment for hotels, restaurants, and
                      hospitality businesses. Discover our extensive range of dinnerware, drinkware,
                      cutlery, and more.
                    </p>
                    <a
                      href="#"
              ...
              <section class="py-16">
                <div class="container mx-auto px-4">
                  <div class="text-center mb-4">
                    <span class="uppercase tracking-wider text-gray-600">Browse</span>
                    <h2
              ...
              <section class="py-4 relative overflow-hidden">
                ...
                <div class="container mx-auto px-4">
                  ...
                  <div class="text-center">
                    <span class="uppercase tracking-wider text-gray-600">Featured</span>
                    <h2
                      class="font-roboto font-black text-4xl bg-gradient-to-r from-[#e82a3e] to-black bg-clip-text text-transparent mt-2"
                    >
              ...
              >
                <div class="container mx-auto px-4 flex flex-col brands">
                  <!-- Section Header -->
                  <div class="text-center mb-4">
                    <span class="uppercase tracking-wider text-gray-600">Partners</span>
                    <h2
                      class="font-roboto font-black text-4xl bg-gradient-to-r from-[#e82a3e] to-black bg-clip-text text-transparent mt-2"
                    >
                      Premium Brands
                  ...
                  <swiper
                    :modules="[SwiperKeyboard, SwiperMousewheel, SwiperAutoplay, SwiperFreeMode]"
                    :slides-per-view="10"
                    :space-between="30"
                    :grab-cursor="true"
                    :centered-slides="true"
...
<script setup>
  ...
  const categories = [
    {
      title: 'Dinnerware',
      subcategories: ['Dinner Plates', 'Side Plates', 'Bowls', 'Serving Platters'],
      description:
    ...
    {
      title: 'Cutlery',
      subcategories: ['Table Covers', 'Dessert Covers', 'Tea and Coffee', 'Steak'],
      description:
    ...
    {
      title: 'Bakeware',
      subcategories: ['Casserole Dishes', 'Pie Dishes', 'Measuring Cups', 'Teapots'],
      description:
  ...
  const featuredProducts = [
    {
      ...
      category: 'Dinnerware',
      features: ['28-Piece Premium Set', 'Microwave & Dishwasher Safe', 'Chip-Resistant Design'],
    ...
    },
    {
      ...
      category: 'Glassware',
      features: ['Lead-free Crystal Glass', 'Set of 6 Each Type', 'Break-Resistant Stems'],
    ...
    },
    {
      ...
      category: 'Buffetware',
      features: ['Temperature Control', 'LED Display Panel', 'Easy-Clean Surface'],
    ...
    },
    {
      ...
      category: 'Flatware',
      features: ['18/10 Stainless Steel', 'Mirror Polish Finish', 'Ergonomic Design'],
    ...
    },
    {
      ...
      features: ['Built-in Water Filter', 'Digital Controls', 'Multiple Brew Options'],
    ...
    },
    {
      ...
      category: 'Barware',
      features: ['Complete Mixology Kit', 'Premium Steel Tools', 'Presentation Case'],
