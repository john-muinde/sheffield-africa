    ...
    <div class="popup-advert">
      <div class="popup-content">
        ...
        <div class="button-group row">
          <button class="btn btn-primary btn-footer col-4" @click="dismissPopup">
            Cancel
          </button>
          <button
...
const fetchProducts = async () => {
  try {
    // Only fetch if promotions are needed
...
const filterValidProducts = (product) => {
  const costPrice = convertToNumber(product.cost_price || product.retail_price);
