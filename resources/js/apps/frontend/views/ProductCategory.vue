               ...
               <div class="col-lg-9">
                  ...
                  <div class="products mb-3">
                     <div class="row">
                        ...
                        <div class="col-6 col-md-3 col-lg-3 col-xl-3" v-for="product in displayedProducts" :key="product.id">
                           ...
                           <div class="product product-7 text-center">
                              ...
                              <div class="product-body">
                                 <div class="product-cat">
                                    <router-link :to="getProductLink(product.id, product.name, product.model_number)" >{{ product.product_brand.name }}</router-link>
                                 </div>
                                 <!-- End .product-cat --> 
                                 <h3 class="product-title">
                                    <router-link :to="getProductLink(product.id, product.name, product.model_number)">{{ product.name }}</router-link>
                                 </h3>
                                 <!-- End .product-title -->
                              ...
                              <div class="filter-items filter-items-count">
                                 ...
                                 <div class="filter-item" v-for="category in categories" :key="category.id" >
                                    <div class="custom-control custom-checkbox"> <input
                                       type="checkbox" class="custom-control-input" :id="'cat-' + category.id"
                                       />
                           ...
                           <div class="widget-body">
                              <div class="filter-items">
                                 <div v-for="brand in brands" :key="brand.id"  class="filter-item">
                                    <div class="custom-control custom-checkbox"> <input
                                       type="checkbox" class="custom-control-input" :id="'brand-' + brand.product_brand"
                                       />
                                       <label class="custom-control-label" :for="'brand-' + brand.product_brand"
...
<script setup>
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      totalCountperPage.value = response.data.products.data.length;
      categories.value = response.data.categories;
      brands.value = response.data.brands;
      the_category.value = response.data.the_category;

      useMeta({ title: the_category.value.name + " | Category" });
