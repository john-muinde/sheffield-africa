          ...
          <aside class="col-lg-2 order-lg-first">
            <div class="sidebar sidebar-shop sidebar-shop-category">
              <div class="widget widget-clean">
                <label>Filters:</label>
                <button class="btn btn-primary btn-sm sidebar-filter-clear" @click="resetSortValues">
                  Clean All
                </button>
              </div>
...
const getCategoryLink = (id, name, page) => {
    ...
    if (name === undefined) {
        ...
        return `/promotional-solutions/${id}/${transformedName}/page/${page}`;
    }
};
...
useMetaLaundry({ title: title.value + 'All you can get Promotions' });
</script>
