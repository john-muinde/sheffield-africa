                                    ...
                                    <router-link to="/media/in-the-news">
                                        <div class="about-team">
                                            <div class="about-team-white">
                                             ...
                                             <div class="details">
                                                <div class="name">In The News</div>
                                    ...
                                    <router-link to="/media/brochures-and-catalogs">
                                        <div class="about-team">
                                            <div class="about-team-white">
                                             ...
                                             <div class="details">
                                                <div class="name">Brochures & Catalogs</div>
                                            </div>
...
<style type="text/css">
    ...
    .about-team {
      ...
      padding: 4.2%;
      border-radius: 50%;
      background: linear-gradient(256deg, #c02434 14.71%, transparent 36.89%), linear-gradient(106deg, #c02434 11.34%, transparent 42.02%);
