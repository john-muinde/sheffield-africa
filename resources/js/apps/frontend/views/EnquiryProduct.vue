            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Enquire Product</a></li>
                    </ol>
                </div>
            </nav>
                ...
                <div class="container">
                	<div class="row">
                		...
                		<div class="col-lg-8">
                			...
                			<p class="mb-2">Learn more about this product <b>`{{ product.name }}`</b> </p>

                			<form action="#" method="POST" class="contact-form mb-3">
                				<div class="row">
                					<div class="col-sm-6">
                						<input type="hidden" name="product_id" v-model="enquiry.product_id">
                                        <label for="cname" class="sr-only">Name</label>
                						<input type="text" class="form-control" id="name" name="Form[name]" v-model="enquiry.name" placeholder="Enter your name *" required>
                					</div><!-- End .col-sm-6 -->

                					<div class="col-sm-6">
                                        <label for="cemail" class="sr-only">Email</label>
                						<input type="email" class="form-control" id="email" name="Form[email]" v-model="enquiry.email" placeholder="Enter your email *" required>
                					</div><!-- End .col-sm-6 -->
                				</div><!-- End .row -->
                				...
                				<div class="row">
                					<div class="col-sm-6">
                						...
                						<input type="tel" class="form-control" id="phone" name="Form[phone]" placeholder="Enter your phone" v-model="enquiry.phone">
                					</div><!-- End .col-sm-6 -->

                					<div class="col-sm-6">
                                        <label for="csubject" class="sr-only">Company</label>
                						<input type="text" class="form-control" id="company" name="Form[company]" v-model="enquiry.company" placeholder="Enter your company">
                					</div><!-- End .col-sm-6 -->
                				</div><!-- End .row -->

                                <label for="cmessage" class="sr-only">Your Query</label>
                				<textarea class="form-control" cols="30" rows="4" id="query" required placeholder="Write your query here *" name="Form[query]" v-model="enquiry.query"></textarea>
 

                				<button type="button" @click="submitForm" class="btn btn-outline-primary-2 btn-minwidth-sm">
                		...
                		<div class="col-lg-4 mb-2 mb-lg-0">
                			<h2 class="title mb-1 text">Product Information</h2><!-- End .title mb-2 -->
                			<img  :src="'/storage/' + product.main_image_path" style="width:80%">
                			<h5 class="header text-primary">{{ product.name }}</h5>
