...
<<<<<<< HEAD
        ...
        <div class="row ">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="banner banner-big" style="overflow: hidden;">
                                <a href="#">
                                    <img style="height: 580px;
    width: auto;" src="/assets/images/about_us.jpeg" alt="Banner">
                                </a>

                                <div class="banner-content">
                                    <h4 class="banner-subtitle text-primary">Green Solutions</h4><!-- End .banner-subtitle -->
                                    <h3 class="banner-title text-white">Learn More <br>about us.</h3><!-- End .banner-title -->
                                    ...
                                    <a href="/contact-us" class="btn btn-primary btn-rounded"><span>Contact Us</span><i class="icon-long-arrow-right"></i></a>
                        ...
                        <div class="col-lg-5">
                            <div class="banner banner-big">
                                <iframe width='100%' height='580' src='https://my.matterport.com/show/?m=JoKVFg4gceE&autoplay=1' frameborder='0' allowfullscreen allow='xr-spatial-tracking'></iframe>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="banner banner-big" style="overflow: hidden">
                    ...
                    <div class="banner-content">
                        <h4 class="banner-subtitle text-primary">
                            Green Solutions
                        </h4>
                        <!-- End .banner-subtitle -->
            ...
            <div class="col-lg-5">
                <div class="banner banner-big">
                    <iframe
                        width="100%"
                        height="580"
                        src="https://my.matterport.com/show/?m=JoKVFg4gceE&autoplay=1"
                        frameborder="0"
                        allowfullscreen
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-sm-6 col-lg-12">
                                    <div class="banner">
                                        <div  class="video-banner video-banner-bg bg-image text-center overlayed-div" style="background-image: url(/assets/images/about_us.jpeg); height:200px;">
                                            <div class="container">
                                                <!-- <h3 class="video-banner-title h1 text-white"><strong>About Us</strong><span>Your Premier Solution and Service Provider for Commercial Kitchen, Laundry, and Cold Storage Solutions in East Africa and Beyond. </span></h3> --><!-- End .video-banner-title -->
                                                <!-- <a href="https://www.youtube.com/watch?v=YvhZ9lOAnSc" class="btn-video btn-iframe"><i class="icon-play"></i></a> -->
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-sm-6 col-lg-12">
                        <div class="banner">
                            <div
                                class="video-banner video-banner-bg bg-image text-center overlayed-div"
                                style="
...
<<<<<<< HEAD
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <div class="banner">
                                        <div  class="video-banner video-banner-bg bg-image text-center overlayed-div" style="background-image: url(/assets/images/about_us.jpeg); height:20px;">
                                            <div class="container">
                                                <!-- <h3 class="video-banner-title h1 text-white"><strong>About Us</strong><span>Your Premier Solution and Service Provider for Commercial Kitchen, Laundry, and Cold Storage Solutions in East Africa and Beyond. </span></h3> --><!-- End .video-banner-title -->
                                                <!-- <a href="https://www.youtube.com/watch?v=YvhZ9lOAnSc" class="btn-video btn-iframe"><i class="icon-play"></i></a> -->
                                                <a @click="showVideoPopup" class="btn-video btn-iframe"><i class="icon-play"></i></a>
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    <h2 class="title ">WHO WE ARE</h2><!-- End .title -->
                                    <p class="lead text-primary mb-3">Transforming Ideas into Sustainable Realities</p><!-- End .lead text-primary -->
                                    <p class="mb-2">Sheffield Steel Systems Limited was founded in 2003 and has expanded over the years to become East Africa’s leading solution and service provider for Commercial Kitchen, Laundry, and Cold Storage Solutions with a niche in Stainless Steel Fabrication and Customization. 
                                    A Kenyan company Headquartered in Nairobi, with country offices in Uganda and Rwanda and project executions across the continent from Ethiopia, Burundi, South Sudan, Nigeria to Congo with ventures into more territories and new business lines. 
                                    A Pan African company focused on providing solutions built to last in Africa. </p>

                                    <router-link to="/about-us/sheffield-advantage" class="btn btn-sm btn-minwidth btn-outline-primary-2">
                                        <span>VIEW SHEFFIELD ADVANTAGES</span>
                                        <i class="icon-long-arrow-right"></i>
                                    </router-link>
                                </div><!-- End .col-lg-5 -->
                                ...
                                <div class="col-lg-6 offset-lg-1">
                                    <div class="about-images">
                                        <img style="margin-left: -10%; margin-top: 10%;" src="/assets/images/sheffield_building_about.jpg" alt="" class="about-img-front">
                                        <img style="margin-top: 0%; margin-right:-15%" src="/assets/images/about_us_back.jpg" alt="" class="about-img-back">
        ...
        <div class="page-content pg-my-blue pt-5">
...
=======
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    ...
                                    <p class="lead text-primary mb-3">
                                        Transforming Ideas into Sustainable
                                        Realities
                                    </p>
                                    ...
                                    <p class="mb-2">
                                        ...
                                        for Commercial Kitchen, Laundry, and
                                        Cold Storage Solutions with a niche in
                                        Stainless Steel Fabrication and
                                        Customization. A Kenyan company
                                        Headquartered in Nairobi, with country
                                        offices in Uganda and Rwanda and project
                                        executions across the continent from
                                        Ethiopia, Burundi, South Sudan, Nigeria
                                        to Congo with ventures into more
                                        territories and new business lines. A
                                        Pan African company focused on providing
                                        solutions built to last in Africa.
                                    </p>
                                    ...
                                    <div class="about-images">
                                        <img
                                            style="
                                                ...
                                                margin-top: 10%;
                                            "
                                            src="/assets/images/sheffield_building_about.jpg"
                                            alt=""
                                        ...
                                        <img
                                            style="
                                                ...
                                                margin-right: -15%;
                                            "
                                            src="/assets/images/about_us_back.jpg"
                                            alt=""
...
<<<<<<< HEAD
                                ...
                                <div class="col-md-5 pt-4">
                                    ...
                                    <h2 class="title">METHODOLOGY</h2><!-- End .title -->
                                    <p class="lead text-primary mb-3">The process at Sheffield Steel Systems</p><!-- End .lead text-primary -->
                                </div>    

                            <div class="col-md-12">        

                                    <p>Understanding our clients’ concepts and space requirements is key to us. We will conduct a site assessment and our in-house team of AutoCAD engineers will design the equipment layout which includes 2D, 3D, Elevations, Isometrics, and Service layouts for a model view of your end solution and product.</p>
                                    <p>We will then customize all your stainless steel requirements in-house at our fabrication plant and our installation team will install the equipment and train the users.
                                    Our service continues with our after-sales support and with our team of technicians who are available on call.
                                    </p>
...
=======
                            <div class="col-md-5 pt-4">
                                ...
                                <!-- End .title -->
                                <p class="lead text-primary mb-3">
                                    The process at Sheffield Steel Systems
                                </p>
                                <!-- End .lead text-primary -->
                            </div>
                            ...
                            <div class="col-md-12">
                                <p>
                                    Understanding our clients’ concepts and
                                    space requirements is key to us. We will
                                    conduct a site assessment and our in-house
                                    team of AutoCAD engineers will design the
                                    equipment layout which includes 2D, 3D,
                                    Elevations, Isometrics, and Service layouts
                                    for a model view of your end solution and
                                    product.
                                </p>
                                <p>
                                    We will then customize all your stainless
                                    steel requirements in-house at our
                                    fabrication plant and our installation team
                                    will install the equipment and train the
                                    users. Our service continues with our
                                    after-sales support and with our team of
                                    technicians who are available on call.
                                </p>
                            </div>
...
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
                                <!-- <ol class="disc-list mt-5 pb-4">
                                  ...
                                  <li>
                                    <span>SPARE PARTS AND MAINTENANCE CONTRACTS</span>
                                    <svg class="pointer">
                                      <path d="M6.25,1.25L11.25,11.25L1.25,11.25L6.25,1.25Z"/>
                                    </svg>
                                  </li>
...
<<<<<<< HEAD
        ...
        <div class="page-content pt-5" :style="{ backgroundImage: 'url(/assets/images/methodology-gray.jpg)' }">
...
<<<<<<< HEAD
                            ...
                            <div class="col-md-12 justify-content-center">  
                                ...
                                <div class="links-container">
                                    ...
                                    <a href="#" class="w3-button w3-round-xlarge w3-theme-l1 w3-border link" target="_blank">

                                        <div class="met-image">
                                            <img src="/assets/images/methodology/methodology01.png">
                                        </div>
                                        
                                        <div class="met-description">
                                            <span class="pull-center">CUSTOMER BRIEF</span>
                                        </div>
                                    </a>
                                    ...
                                    <a href="#" class="w3-button w3-round-xlarge w3-theme-l1 w3-border link" target="_blank">
                                        ...
                                        <div class="met-image">
                                            <img src="/assets/images/methodology/methodology02.png">
                                        </div>
        ...
        <div class="page-content bg-image-breaker bg-image-breaker1">  
           <!--  <img class="image1" src="/assets/images/about_workshop.jpeg"> -->
        </div>
...
=======
                            ...
                            <div class="col-md-12 justify-content-center">
                                <div class="links-container">
                                    <a
                                        href="#"
                                        class="w3-button w3-round-xlarge w3-theme-l1 w3-border link"
                                        target="_blank"
                                    >
                                        <div class="met-image">
                                            <img
                                                src="/assets/images/methodology/methodology01.png"
                                            />
                                        </div>
                                    ...
                                    >
                                        <div class="met-image">
                                            <img
                                                src="/assets/images/methodology/methodology02.png"
                                            />
                                        </div>
...
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
        ...
        <div class="page-content bg-about-black div-after-bg-image-breaker">
<<<<<<< HEAD
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    <h2 class="title">CULTURE</h2><!-- End .title -->
                                    <p class="lead text-primary mb-3">Nurturing Innovation, Embracing Unity</p><!-- End .lead text-primary -->
                                    <p class="mb-2">At Sheffield, we work in a collaborative work culture with an open-door policy that encourages interaction and emphasizes our value for collective teamwork dynamics. The culture blend comes in through inspirational leaders who are always willing to take risks that will benefit the organization. Being a company that thrives on new ideas in both product and concept design, Sheffield’s environment encourages open-minded, innovative, and driven employees. </p>
=======
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        emphasizes our value for collective
                                        teamwork dynamics. The culture blend
                                        comes in through inspirational leaders
                                        who are always willing to take risks
                                        that will benefit the organization.
                                        Being a company that thrives on new
                                        ideas in both product and concept
                                        design, Sheffield’s environment
                                        encourages open-minded, innovative, and
                                        driven employees.
                                    </p>
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
...
<<<<<<< HEAD
                                    ...
                                    <div class="grid">
                                        <ul id="hexGrid">
                                          <li class="hex">
                                            <div class="hexIn">
                                              <div class="hexLink">
                                                <div class='img' style='background-image:url(assets/images/homepage/sheffield_engineer.jpg);'></div>
                                          ...
                                          <li class="hex">
                                            <div class="hexIn">
                                              <div class="hexLink" >
                                                    <div class='img' style='background-image: url(assets/images/oceans.jpg);'>
                                                        
                                                         <video autoplay muted loop class="my-video" id="myVideo" @play="hideOverlay">
                                                    <source src="/assets/videos/oceans.mp4" type="video/mp4">
                                                  </video>
                                          ...
                                          <li class="hex">
                                            <div class="hexIn">
                                              <div class="hexLink" >
                                                <div class='img' style='background-image: url(assets/images/workshop_sheffield.jpg);'></div>
                                                <!-- <h1 id="demo1">This is a title</h1>
                                                <p id="demo2">Some sample text about the article this hexagon leads to</p> -->
                                              </div>
                                            </div>
                                          ...
                                          <li class="hex">
                                            <div class="hexIn">
                                              <div class="hexLink" >
                                                <div class='img' style='background-image: url(assets/images/tree.jpg);'>
                                                     <video autoplay muted loop class="my-video" id="myVideo" @play="hideOverlay">
                                                      <source src="/assets/videos/wind_energy.mp4" type="video/mp4">
                                                    </video>
                                                </div>
                                                <!-- <h1 id="demo1">This is a title</h1>
                                                <p id="demo2">Some sample text about the article this hexagon leads to</p> -->
                                          ...
                                          <li class="hex">
                                            <div class="hexIn">
                                              <div class="hexLink" >
                                                <div class='img' style='background-image: url(assets/images/welding.jpg);'></div>
                                                <!-- <h1 id="demo1">This is a title</h1>
                                                <p id="demo2">Some sample text about the article this hexagon leads to</p> -->
                                              </div>
                                            </div>
                                          ...
                                          <li class="hex">
                                            <div class="hexIn">
                                              <div class="hexLink" >
                                             <div class='img' style='background-image: url(assets/images/chef.jpg);'></div>
                                                <!-- <h1 id="demo1">This is a title</h1>
                                                <p id="demo2">Some sample text about the article this hexagon leads to</p> -->
                                              </div>
                                            </div>
        ...
        <div class="page-content bg-about-light-blue">
                                                ...
                                                <div class="hexIn">
                                                    <div class="hexLink">
                                                        <div
                                                            class="img"
                                                            style="
                                                                background-image: url(assets/images/oceans.jpg);
                                                            "
                                                        >
                                                            <video
                                                                autoplay
                                                ...
                                                <div class="hexIn">
                                                    <div class="hexLink">
                                                        <div
                                                            class="img"
                                                            style="
                                                                background-image: url(assets/images/workshop_sheffield.jpg);
                                                            "
                                                        ></div>
                                                        <!-- <h1 id="demo1">This is a title</h1>
                                                <p id="demo2">Some sample text about the article this hexagon leads to</p> -->
                                                ...
                                                <div class="hexIn">
                                                    <div class="hexLink">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <source
                                                                    src="/assets/videos/wind_energy.mp4"
                                                                    type="video/mp4"
                                                                />
                                                            </video>
                                                        </div>
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    <h2 class="title">PEOPLE</h2><!-- End .title -->
                                    <p class="lead text-primary mb-3">Meet our amazing team</p><!-- End .lead text-primary -->
                                    <p class="mb-2">Sheffield boasts of a team of qualified professionals with expertise in Engineering, Project Management, and Technical Skills that contribute to the process of Innovation and The Sheffield Methodology. </p>
=======
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    ...
                                    <!-- End .lead text-primary -->
                                    <p class="mb-2">
                                        Sheffield boasts of a team of qualified
                                        professionals with expertise in
                                        Engineering, Project Management, and
                                        Technical Skills that contribute to the
                                        process of Innovation and The Sheffield
                                        Methodology.
                                    </p>
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
...
<<<<<<< HEAD
                                ...
                                <div class="col-md-6 offset-md-1">
                                    <div class="colored-card  mt-5">
                                        <h5 class="text-4 pt-3 pl-2">Sheffield Team In Numbers</h5>
                                       

                                        <div class="row icon-boxes-container pl-2">
                                            <div class="col counter_col">

                                               
                                                <h3 class="count-to text-primary mb-0">
                                                    {{ staffCount }}+ <span> Staff</span>
                                                </h3>

                                                <h3 class="count-to text-primary mb-0">
                                                    {{ engineersCount }}+&nbsp; <span> Engineering & Technical Skilled Crew</span>
                                                </h3>

                                                <h3 class="count-to text-primary mb-0">
                                                    {{ executiveCount }}+&nbsp;&nbsp;&nbsp; <span> Executive Leaders</span>
                                                </h3>

                                                <h3 class="count-to text-primary mb-0">
                                                    {{ designCount }}+&nbsp;&nbsp;&nbsp; &nbsp;<span> Design Engineers</span>
                                                </h3>

                                                <h3 class="count-to text-primary mb-0">
                                                    {{ inhouseCount }}+&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span> In-house Chefs & Baristas</span>
                                                </h3>
...
=======
                                ...
                                <div class="col-md-6 offset-md-1">
                                    <div class="colored-card mt-5">
                                        <h5 class="text-4 pt-3 pl-2">
                                            Sheffield Team In Numbers
                                        </h5>

                                        <div
                                            class="row icon-boxes-container pl-2"
                                        >
                                            <div class="col counter_col">
                                                <h3
                                                    class="count-to text-primary mb-0"
                                                >
                                                    {{ staffCount }}+
                                                    <span> Staff</span>
                                                </h3>
...
<<<<<<< HEAD
        ...
        <div class="page-content bg-image-breaker  bg-image-breaker2">  
            <!-- <img class="image2" src="/assets/images/about_image.jpeg"> -->
        </div>

         <div class="page-content pg-my-black  pt-5">
...
<<<<<<< HEAD
                                ...
                                <div class="col-md-5 pt-4">
                                    ...
                                    <h2 class="title">LEADERSHIP</h2><!-- End .title -->
                                    <p class="lead text-primary mb-3">Meet the Minds Behind Our Success</p><!-- End .lead text-primary -->
                                </div>    

                            <div class="col-md-12">        

                                    <p>Our leadership team is made up of dedicated, focused, and experienced executives working with each other and their teams to implement Sheffield’s strategy and vision, their knowledge and experience come together to make a difference for all our stakeholders.</p>
...
<<<<<<< HEAD
        ...
        <div class="page-content csr-container">
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    <h2 class="title">CSR </h2><!-- End .title -->
                                    <p class="lead text-primary mb-3">Making a Difference: Our Commitment to CSR</p><!-- End .lead text-primary -->
                                    <p class="mb-2">Since its inception, Sheffield Africa has been at the forefront of commitment to achieve corporate social responsibility. To underline our deep commitment to making a difference in people’s lives, we are guided by an existing policy that drives initiatives focusing on Education, Employment, Health, Community Development, and Environmental Sustainability. </p>
=======
                                <div class="col-lg-5 mb-3 mb-lg-0 pt-4">
                                    <h2 class="title">CSR</h2>
                                    <!-- End .title -->
                                    <p class="lead text-primary mb-3">
                                        Making a Difference: Our Commitment to
                                        CSR
                                    </p>
                                    <!-- End .lead text-primary -->
                                    <p class="mb-2">
                                        Since its inception, Sheffield Africa
                                        has been at the forefront of commitment
                                        to achieve corporate social
                                        responsibility. To underline our deep
                                        commitment to making a difference in
                                        people’s lives, we are guided by an
                                        existing policy that drives initiatives
                                        focusing on Education, Employment,
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-6 offset-lg-1">
                                    ...
                                    <div class="csr-image">
                                        <img src="/assets/images/sheffield csr.jpg" class="img" alt="">
                                    </div>
...
=======
                                ...
                                <div class="col-lg-6 offset-lg-1">
                                    <div class="csr-image">
                                        <img
                                            src="/assets/images/sheffield csr.jpg"
                                            class="img"
                                            alt=""
                                        />
                                    </div>
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-12 mb-3 mb-lg-0 pt-4">
                                    <h2 class="title">PARTNERS</h2><!-- End .title -->
                                    <p class="lead text-primary mb-3">Nurturing Innovation, Embracing Unity</p><!-- End .lead text-primary -->
                                    <p class="mb-2">Sheffield partners with world leaders in its product brands and technology. Our partners are like-minded visionary companies continuously innovating to offer the best in the industry </p>
=======
                                <div class="col-lg-12 mb-3 mb-lg-0 pt-4">
                                    ...
                                    <!-- End .lead text-primary -->
                                    <p class="mb-2">
                                        Sheffield partners with world leaders in
                                        its product brands and technology. Our
                                        partners are like-minded visionary
                                        companies continuously innovating to
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-2 col-sm-6 col-xs-6">
                                    ...
                                    <img width="100%" src="/assets/images/partners/partners1.png">

                                </div><!-- End .col-lg-6 -->

                                <div class="col-lg-2 col-sm-6 col-xs-6">
                            
                                    <img width="100%" src="/assets/images/partners/partners2.png">

                                </div><!-- End .col-lg-6 -->

                                <div class="col-lg-2 col-sm-6 col-xs-6">
                            
                                    <img width="100%" src="/assets/images/partners/partners3.png">

                                </div><!-- End .col-lg-6 -->

                                <div class="col-lg-2 col-sm-6 col-xs-6">
                            
                                    <img width="100%" src="/assets/images/partners/partners4.png">

                                </div><!-- End .col-lg-6 -->

                                <div class="col-lg-2 col-sm-6 col-xs-6">
                            
                                    <img width="100%" src="/assets/images/partners/partners5.png">

                                </div><!-- End .col-lg-6 -->

                                <div class="col-lg-2 col-sm-6 col-xs-6">
                            
                                    <img width="100%" src="/assets/images/partners/partners6.png">
...
=======
                                ...
                                <div class="col-lg-2 col-sm-6 col-xs-6">
                                    <img
                                        width="100%"
                                        src="/assets/images/partners/partners2.png"
                                    />
                                </div>
                                <!-- End .col-lg-6 -->
                                ...
                                <div class="col-lg-2 col-sm-6 col-xs-6">
                                    <img
                                        width="100%"
                                        src="/assets/images/partners/partners3.png"
                                    />
                                </div>
                                <!-- End .col-lg-6 -->
                                ...
                                <div class="col-lg-2 col-sm-6 col-xs-6">
                                    <img
                                        width="100%"
                                        src="/assets/images/partners/partners4.png"
                                    />
                                </div>
                                <!-- End .col-lg-6 -->
                                ...
                                <div class="col-lg-2 col-sm-6 col-xs-6">
                                    <img
                                        width="100%"
                                        src="/assets/images/partners/partners5.png"
                                    />
                                </div>
                                <!-- End .col-lg-6 -->
                                ...
                                <div class="col-lg-2 col-sm-6 col-xs-6">
                                    <img
                                        width="100%"
                                        src="/assets/images/partners/partners6.png"
                                    />
                                </div>
                                <!-- End .col-lg-6 -->
                            </div>
...
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
        ...
        <div class="page-content pg-my-blue">
            <div class="container">
<<<<<<< HEAD
                    ...
                    <div class="col-lg-10 offset-lg-1 mb-5 mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12  mb-3 mb-lg-0 pt-4">
                                ...
                                <h2 class="title">Clients</h2><!-- End .title -->
                                <p class="lead text-primary mb-3">Partnering with Industry Leaders</p>
...
const dataCounter = [
    ...
    { count: 200, ref: staffCount },
    { count: 100, ref: engineersCount },
    { count: 30, ref: executiveCount },
    { count: 10, ref: designCount },
    { count: 5, ref: inhouseCount },
];
...
.bg-image-breaker1 {
  background-image: url("/assets/images/about_back_1.jpg");
}

.bg-image-breaker2 {
  background-image: url("/assets/images/about_back_2.jpg");
}

.bg-image-breaker3 {
  background-image: url("/assets/images/about_back_3.jpg");
}
...
<<<<<<< HEAD
  ...
  padding: 4.2%;
  border-radius: 50%;
  background: linear-gradient(251deg, red 14.71%, transparent 26.89%), linear-gradient(106deg, red 11.34%, transparent 42.02%);
...
=======
    ...
    padding: 4.2%;
    border-radius: 50%;
    background: linear-gradient(251deg, red 14.71%, transparent 26.89%),
        linear-gradient(106deg, red 11.34%, transparent 42.02%);
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
}
...
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
    ...
    width: 100%;
    height: 100%;
    object-fit: cover; /* Maintain aspect ratio and cover the round div */
...
.csr-image img {
  transform: rotateX(61deg) rotateZ(46deg) translate3d(-120px, 0px, 70px);
  box-shadow: -80px 60px 15px 5px rgba(0,0,0,0.4);
  transition: all .4s;
  transform-style: preserve-3d;
}
.csr-container:hover img {
...
/* Masonry layout for the .masonry container */
.masonry {
<<<<<<< HEAD
  display: grid;
...
@media (max-width: 768px) {
  .masonry {
    grid-template-columns: repeat(auto-fill, minmax(40px, 1fr)); /* Adjust column width */
  }
}
