                ...
                <div class="page-content pg-white">
                    <div class="mb-lg-5">
                        <div class="container">
                            <div class="row no-margin">
                                <div
                                    class="col-lg-12 justify-content-center mt-1"
                                >
                                    ...
                                    <div
                                        class="row mt-3 graduate-intake hex-section-career"
                                    >
                                        <div class="col-lg-12 mb-3">
                                            <p class="who-we-are-p">
                                                Sheffield Africa is an equal
                                                opportunity employer with
                                                opportunities to guide your
                                                career. We are always sourcing
                                                for problem solvers and creative
                                                thinkers from engineers to sales
                                                and marketing personnel. Put
                                                your talents to use where
                                                opportunities are limitless and
                                                every day makes a difference.
                                                Whether you’re an experienced
                                                professional or a recent
                                                graduate, working with Sheffield
                                                Africa will be a rewarding
                                                experience that will grow your
                                                career.
                                            </p>
                                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div
                                            class="col-lg-8 offset-lg-1 who-we-are"
                                        >
                                            <h5 class="mt-2">Benefits</h5>

                                            <ul
                                                class="graduate-trainee-program"
                                            >
                                                <li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div
                                    class="col-lg-10 offset-lg-1 who-we-are"
                                    id="fill_fomr"
                                >
                                    ...
                                    <div class="row">
                                        <div
                                            class="offset-lg-1 col-md-10 register-right mt-2"
                                        >
                                            <div class="" id="myTabContent">
                                                <div
                                                    class=""
...
useHead({
    title: "Career | Sheffield Africa | Your Gateway to Success in Africa",
    meta: [
        {
            name: "description",
            content:
                "Sheffield Africa is dedicated to empowering businesses in Africa through innovative solutions and expert services. We specialize in providing strategic consulting, project management, and business development services tailored to the unique needs of our clients. Join our dynamic team to help shape the future of businesses across the continent. Discover opportunities for growth and success with Sheffield Africa, where your career can thrive while making a meaningful impact.",
        },
        {
            property: "og:title",
            content:
                "Career | Sheffield Africa | Your Gateway to Success in Africa",
        },
        {
            property: "og:description",
            content:
                "Sheffield Africa is dedicated to empowering businesses in Africa through innovative solutions and expert services.",
        },
    ],
>>>>>>> b1327f8448e14b925438ec1cdeed9a33675301cb
});
