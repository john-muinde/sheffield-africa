            ...
            <div class="navbar-item flex-row ms-md-auto">
                ...
                <div class="dropdown nav-item user-profile-dropdown btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right m-0" aria-labelledby="ddluser">
                        ...
                        <li role="presentation">
                            <a disabled="processing" href="javascript:void(0)" @click="logoutAdmin"
                                class="dropdown-item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <ul class="collapse list-unstyled sub-submenu">
                                ...
                                <li class="sub-sub-sub-submenu-list">
                                    ...
                                    <ul class="collapse list-unstyled sub-sub-submenu">
                                        ...
                                        <li><router-link to="/tables/v3-table/order-sorting">Order Sorting</router-link>
                                        </li>
                                        <li><router-link to="/tables/v3-table/multi-column">Multi Column</router-link>
                                        </li>
                                        ...
                                        <li><router-link to="/tables/v3-table/range-search">Range Search</router-link>
                                        </li>
                                        ...
                                        <li><router-link to="/tables/v3-table/miscellaneous">Miscellaneous</router-link>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
...
const { user, processing, logoutAdmin } = useAuth();
