                    ...
                    <div class="custom-table text-nowrap">
                        ...
                        >
                            ...
                            <template #image="props">
                                <img
                                    :src="
                                        '/storage/' + props.row.main_image_path
                                    "
                            ...
                            <template #actions="props">
                                ...
                                <a
                                    href="javascript:;"
                                    @click.prevent="deleteGallery(props.row.id)"
...
const { gallerys, getGallerys, deleteGallery } = useGallerys();
...
const getTableData = () => {
    return gallerys.value && Array.isArray(gallerys.value.data)
        ? gallerys.value.data
        : [];
};
