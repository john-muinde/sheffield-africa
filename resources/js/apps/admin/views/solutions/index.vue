                                    ...
                                    <table role="table" aria-busy="false" aria-colcount="5" class="table table-striped table-bordered" id="__BVID__415">
                                        <thead role="rowgroup">
                                            <tr role="row">
                                                ...
                                                <th role="columnheader" scope="col" aria-colindex="2"><div>Description</div></th>
                                                <th role="columnheader" scope="col" aria-colindex="3"><div>Parent Category</div></th>
                                                <th role="columnheader" scope="col" aria-colindex="4"><div>Status</div></th>
                                                <th role="columnheader" scope="col" aria-colindex="5"><div>Created At</div></th>
                                                <th role="columnheader" scope="col" aria-colindex="6" aria-label="Action" class="text-center"><div>action</div></th>
                                            </tr>
                                        </thead>
                                        <tbody role="rowgroup">
                                            ...
                                            <tr v-for="the_category in displayedProducts"  :key="category.id" role="row" class="">
                                                ...
                                                <td aria-colindex="1" role="cell">
                                                    <img style="width: 80px;" :src="'/storage/' + the_category.main_image_path" class="rounded profile-img" alt="avatar" />
                                                </td>
                                                
                                                <td aria-colindex="1" role="cell">{{ the_category.name }}</td>
                                                <td aria-colindex="2" role="cell" v-html="the_category.description"></td>
                                                <td aria-colindex="3" role="cell">{{ the_category.solution_category.name }}</td>
                                                <td aria-colindex="4" role="cell">
                                                    
                                                    <span v-if="the_category.is_published === 1" class="badge badge-success inv-status">Published</span>

                                                    <span v-if="the_category.is_published !== 1" class="badge badge-danger inv-status">Not Published</span>

                                                </td>
                                                <td aria-colindex="5" role="cell">{{ the_category.created_at }}</td>
                                                ...
                                                <td aria-colindex="6" role="cell" class="text-center">
                                                    ...
                                                    <div class="btn-group dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                                            <router-link :to="{ name: 'solutions.edit', params: { id: the_category.id } }" class="dropdown-item" >Edit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <router-link :to="{ name: 'solutions.category.sequence', params: { id: the_category.id } }" class="dropdown-item" >Update Category Sequence &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <a href="javascript:;" @click.prevent="deleteSolution(the_category.id)"  class="dropdown-item" >Delete &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script setup>
    ...
    const fetchProducts = async () => {
        ...
        try {
            ...
            const response = await axios.get('/api/get-solutions', {
                params: {
  ...
  const updateDatabaseOrder = async (formData) => {
    ...
    try {
        ...
        const response = await axios.post('/api/solutions-update-order', { data: formData });
