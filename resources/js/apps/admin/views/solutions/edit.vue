                            ...
                            <form @submit.prevent="submitForm">
                                ...
                                <div  class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <multiselect v-model="solution.categories" :options="categoryList" :reduce="category => category.id" :multiple="true" :taggable="true" :searchable="true" :preselect-first="true" track-by="id" label="parent_name_with_dashes" placeholder="Choose Product Category ..." selected-label="" select-label="" deselect-label=""></multiselect>
                                    ...
                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                        ...
                                        <label class="custom-file-container__custom-file" for="main_image" >
                                            <input type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/*" @change="solution.main_image = $event.target.files[0]" id="main_image">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div>
                                            <select v-model="solution.is_published" id="is_published" class="form-select">
