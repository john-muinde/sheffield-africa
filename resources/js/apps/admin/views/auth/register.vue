                ...
                <div class="form-form-wrap">
                    <div class="form-container">
                        <div class="form-content">
                            ...
                            <p class="signup-link">Already have an account? <router-link to="/admin/login">Log
                                    in</router-link></p>
                                    <form class="text-start" @submit.prevent="submitRegisterAdmin">
                                <div class="form">
                                    <div id="name-field" class="field-wrapper input">
                                        ...
                                        <input v-model="registerForm.name" type="text" class="form-control" required
                                            autofocus autocomplete="username" placeholder="Your Name" />
                                    ...
                                    <div id="email-field" class="field-wrapper input">
                                        ...
                                        <input v-model="registerForm.email" id="singin-email-2" type="email"
                                    ...
                                    <div id="password-field" class="field-wrapper input mb-2">
                                        ...
                                        <input v-model="registerForm.password" id="singin-password-2" type="password"
                                            class="form-control" required autocomplete="confirm-password"
                                    ...
                                    <div class="field-wrapper terms_condition">
                                        <div class="checkbox-outline-primary custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" value="true"
                                                id="chkTerms" />
                                            <label class="custom-control-label" for="chkTerms">I agree to the <a
                            ...
                            <p class="terms-conditions">
                                © 2020 All Rights Reserved. <router-link to="/">CORK</router-link> is a product of
                                Arrangic Solutions LLP. <a href="javascript:void(0);">Cookie Preferences</a>, <a
                                    href="javascript:void(0);">Privacy</a>, and
...
const { registerForm, validationErrors, processing, submitRegisterAdmin } = useAuth();
