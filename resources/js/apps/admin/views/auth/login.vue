                        ...
                        <div class="form-content">
                            ...
                            <form class="text-start" @submit.prevent="submitLoginAdmin">
                                <div class="form">
                                    ...
                                    <div class="field-wrapper">
                                        <router-link to="/admin/pass-recovery" class="forgot-pass-link">Forgot Password?</router-link>
                                    </div>
                                </div>
                            </form>
                            <p class="terms-conditions">
                                © {{year}} All Rights Reserved. <router-link to="/">Sheffield Africa</router-link>. <br><a href="javascript:void(0);">Cookie Preferences</a>, <a href="javascript:void(0);">Privacy</a>, and
