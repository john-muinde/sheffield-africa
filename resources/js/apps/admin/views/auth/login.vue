                ...
                <div class="form-form-wrap">
                    <div class="form-container">
                        <div class="form-content">
                            <h1 class="">
                                Log in<router-link to="/admin/login"><span class="brand-name"></span></router-link>
                            </h1>
                            ...
                            <form class="text-start" @submit.prevent="submitLoginAdmin">
                                <div class="form">
                                    <div id="username-field" class="field-wrapper input">
                                        ...
                                        <input v-model="loginForm.email" id="singin-email-2" type="email"
                                    ...
                                    <div id="password-field" class="field-wrapper input mb-2">
                                        ...
                                        <input v-model="loginForm.password" id="singin-password-2" type="password"
                                    ...
                                    <div class="field-wrapper text-center keep-logged-in">
                                        <div class="checkbox-outline-primary custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" value="true"
                                                id="chkRemember" />
                                            <label class="custom-control-label" for="chkRemember">Keep me logged
                                                in</label>
                                        </div>
                                    </div>

                                    <div class="field-wrapper">
                                        <router-link to="/admin/pass-recovery" class="forgot-pass-link">Forgot
                            ...
                            <p class="terms-conditions">
                                ...
                                <router-link to="/">Sheffield Africa</router-link>. <br /><a
