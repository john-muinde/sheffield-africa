      ...
      <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        <div class="panel br-6 p-0">
          ...
          <div class="custom-table">
            ...
            >
              <template #testimonial_image="props">
                <img
              ...
              <template #actions="props">
                ...
                <router-link
                  :to="{ name: 'testimonials.edit', params: { id: props.row.id } }"
                  class="badge bg-info"
...
const getTableData = () => {
  return testimonials.value && Array.isArray(testimonials.value.data)
