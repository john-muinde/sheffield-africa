                            ...
                            <div class="accordion" id="faq">
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <div class="mb-0 collapsed" role="menu" data-bs-toggle="collapse"
                                    ...
                                    <div id="fqcollapseOne" class="collapse" aria-labelledby="fqcollapseOne"
                                        data-bs-parent="#faq">
                                        <div class="card-body">
                                            <p>
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <div class="mb-0 collapsed" role="menu" data-bs-toggle="collapse"
                                            data-bs-target="#fqcollapseTwo" aria-expanded="true"
                                    ...
                                    <div id="fqcollapseTwo" class="collapse show" aria-labelledby="fqcollapseTwo"
                                        data-bs-parent="#faq">
                                        <div class="card-body">
                                            <p>
                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                                ...
                                <div class="card">
                                    ...
                                    <div id="fqcollapseThree" class="collapse" aria-labelledby="fqcollapseThree"
                                        data-bs-parent="#faq">
                                        <div class="card-body">
                                            <p>
                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                                ...
                                <div class="card">
                                    ...
                                    <div id="fqcollapseFour" class="collapse" aria-labelledby="fqcollapseFour"
                                        data-bs-parent="#faq">
                                        <div class="card-body">
                                            <p>
                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                                ...
                                <div class="card">
                                    ...
                                    <div id="fqcollapseFive" class="collapse" aria-labelledby="fqcollapseFive"
                                        data-bs-parent="#faq">
                                        <div class="card-body">
                                            <p>
                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                                ...
                                <div class="card">
                                    ...
                                    <div id="fqcollapseSix" class="collapse" aria-labelledby="fqcollapseSix"
                                        data-bs-parent="#faq">
                                        <div class="card-body">
                                            <p>
                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                ...
                <div class="fq-article-section">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
                            <div class="card">
                                <img src="/assets/images/masonry-blog-style-3.jpeg" alt="faq-video-tutorials"
                                    class="card-img-top" />
                                <div class="card-body">
                                    <div class="fq-rating">
                                        <svg v-for="i in 5" :key="i" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
                            <div class="card">
                                <img src="/assets/images/grid-blog-style-2.jpeg" alt="faq-video-tutorials"
                                    class="card-img-top" />
                                <div class="card-body">
                                    <div class="fq-rating">
                                        <svg v-for="i in 5" :key="i" xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            class="feather feather-star" :class="{ checked: i < 5 }">
                                            <polygon
                                                points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
                                            </polygon>
                                        </svg>
                        ...
                        <div class="col-lg-3 col-md-6 mb-md-0 mb-4">
                            <div class="card">
                                <img src="/assets/images/list-blog-style-3.jpeg" alt="faq-video-tutorials"
                                    class="card-img-top" />
                                <div class="card-body">
                                    <div class="fq-rating">
                                        <svg v-for="i in 5" :key="i" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card">
                                <img src="/assets/images/masonry-blog-style-4.jpeg" alt="faq-video-tutorials"
                                    class="card-img-top" />
                                <div class="card-body">
                                    <div class="fq-rating">
                                        <svg v-for="i in 5" :key="i" xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            class="feather feather-star" :class="{ checked: i < 4 }">
                                            <polygon
                                                points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
                                            </polygon>
                                        </svg>
