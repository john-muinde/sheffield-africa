                            ...
                            <form @submit.prevent="submitForm">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="csr_introduction"
                                            >CSR Introduction</label
                                        >
                                    ...
                                    <div class="form-group">
                                        <label for="post_company_involvement"
                                            >Company Involvement</label
                                        >
                                    ...
                                    <div class="form-group">
                                        <label for="post_collaborations_and_partnership"
                                            >Collaborations & Partnerships</label
                                        >
