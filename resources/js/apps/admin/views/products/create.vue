                            ...
                            <form @submit.prevent="submitForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input v-model="product.name" id="post-name" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <multiselect v-model="product.brand" :options="brandList"
                                            :reduce="brand => brand.id" :searchable="true" :preselect-first="true"
                                            track-by="name" label="name" placeholder="Choose Brand ...">
                                        </multiselect>
                                        <div class="text-danger mt-1">
                                            {{ errors.brand }}
                                        </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.model_number" id="post-brand" type="text"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.sku" id="post-sku" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.quantity" id="post-quantity" type="text"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.cost_price" id="post-cost_price" type="text"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.retail_price" id="post-retail_price" type="text"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.weight" id="post-weight" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <multiselect v-model="product.categories" :options="categoryList"
                                            :reduce="category => category.id" :multiple="true" :taggable="true"
                                            :searchable="true" :preselect-first="true" track-by="id"
                                            label="parent_name_with_dashes" placeholder="Choose Product Category ..."
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.length" id="post-length" type="text"
                                            class="form-control" placeholder="Enter Length (mm) ..." />
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.height" id="post-height" type="text"
                                            class="form-control" placeholder="Enter Height (mm) ..." />
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="product.width" id="post-width" type="text" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <quill-editor v-model:value="product.short_description" id="short_description"
                                            :options="options1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <quill-editor v-model:value="product.description" :options="options1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <quill-editor v-model:value="product.technical_specification"
                                            :options="options1"
                                            placeholder="Enter Technical Specification ..."></quill-editor>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <quill-editor v-model:value="product.terms_of_operation" :options="options1"
                                            placeholder="Enter Terms of Operation ..."></quill-editor>
                                    ...
                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                        <label>Upload Main Product Image <a href="javascript:void(0)"
                                                class="custom-file-container__image-clear"
                                                title="Clear Image">x</a></label>
                                        <label class="custom-file-container__custom-file" for="main_image">
                                            <input type="file"
                                                class="custom-file-container__custom-file__custom-file-input"
                                                accept="image/*" @change="product.main_image = $event.target.files[0]"
                                                id="main_image">
                                    ...
                                    <div class="custom-file-container" data-upload-id="myProductGallery">
                                        <label>Product Gallery (multiple images allowed) <a href="javascript:void(0)"
                                                class="custom-file-container__image-clear"
                                                title="Clear Image">x</a></label>
                                        <label class="custom-file-container__custom-file" for="product_gallery">
                                            <input type="file"
                                                class="custom-file-container__custom-file__custom-file-input"
                                                accept="image/*" ref=product_gallery multiple id="product_gallery">
                                            <input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
                                            <span
                                                class="custom-file-container__custom-file__custom-file-control"></span>
                                        </label>
                                    ...
                                    <div class="custom-file-container" data-upload-id="myDocument">
                                        <label>Technical Specification Document <a href="javascript:void(0)"
                                                class="custom-file-container__image-clear"
                                                title="Clear Image">x</a></label>
                                        <label class="custom-file-container__custom-file" for="document">
                                            <input type="file"
                                                class="custom-file-container__custom-file__custom-file-input"
                                                accept=".pdf,.doc,.docx"
                                                @change="product.document = $event.target.files[0]" id="document">
                                            <input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
                                            <span
                                                class="custom-file-container__custom-file__custom-file-control"></span>
                                        </label>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div>
                                            <select v-model="product.is_published" id="is_published"
                                                class="form-select">
