                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>View Categories</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                                    ...
                                    <table role="table" aria-busy="false" aria-colcount="5" class="table table-striped table-bordered" id="__BVID__415">
                                        ...
                                        <tbody role="rowgroup">
                                            ...
                                            <tr v-for="the_category in displayedProducts"  :key="category.id" role="row" class="">
                                                ...
                                                <td aria-colindex="2" role="cell">{{ the_category.description }}</td>
                                                <td aria-colindex="3" role="cell">{{ the_category.parent ? the_category.parent.name : '----' }}</td>
                                                ...
                                                <td aria-colindex="6" role="cell" class="text-center">
                                                     <router-link :to="{ name: 'categories.edit', params: { id: the_category.id } }" class="badge bg-info" data-bs-toggle="tooltip" data-bs-placement="top">
                                                    ...
                                                    <a href="javascript:;" @click.prevent="deleteCategory(the_category.id)" class="ms-2 badge bg-danger" data-bs-toggle="tooltip" data-bs-placement="top">
...
<script setup>
  ...
  const updateDatabaseOrder = async (formData) => {
    ...
    try {
        ...
        const response = await axios.post('/api/categories-update-order', { data: formData });
