                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:;">Catgeories</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>Create Category</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                        ...
                        <div class="panel-body">
                            ...
                            <form @submit.prevent="submitForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select v-model="category.is_published" id="is_published" class="form-select">
