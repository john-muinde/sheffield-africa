...
const validateYoutubeUrl = () => {
    ...
    if (!youtubeUrlPattern.test(newss.video_url)) {
...
watchEffect(() => {
    newss.id = postData.value.id;
    newss.name = postData.value.name;
    newss.description = postData.value.description;
    newss.type = postData.value.type;
    newss.is_published = postData.value.is_published;
    newss.main_image = postData.value.main_image_path;
    newss.file_path = postData.value.file_path;
});
</script>
