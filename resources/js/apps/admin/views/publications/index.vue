                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:;">Publications</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>View Publications</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                ...
                <div class="panel br-6 p-0">
                    ...
                    <div class="custom-table">
                        <v-client-table :data="getTableData()" :columns="columns" :options="table_option">
                            ...
                            <template #publication_file="props">
                                <a class="btn btn-primary" :href="'/storage/' + props.row.publication_file" target="_blank">View file</a>
                            </template>
                            ...
                            <template #actions="props">
                                ...
                                <router-link :to="{ name: 'publications.edit', params: { id: props.row.id } }" class="badge bg-info" data-bs-toggle="tooltip" data-bs-placement="top">
...
<script setup>
    ...
    const getTableData = () => {
      return publications.value && Array.isArray(publications.value.data)
    ...
    const columns = ref(["name", "publication_file", "type", "is_published", "created_at", "actions"]);
