                            ...
                            <form @submit.prevent="submitForm">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input v-model="client.name" id="post-name" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input v-model="client.phone" id="post-phone" type="text" class="form-control"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input v-model="client.email" id="post-email" type="email" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input v-model="client.address" id="post-address" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea v-model="client.description" id="post_description" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                        <label>Upload Client Logo
                                            <a id="brand_image" href="javascript:void(0)"
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select v-model="client.is_published" id="is_published" class="form-select">
