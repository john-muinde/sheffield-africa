...
export default function usePublications() {
    ...
    const getPublications = async (
        ...
        axios.get('/api/publications?page=' + page +
            '&search_id=' + search_id +
    ...
    const storePublication = async (publication,  files) => {
        ...
        axios.post('/api/publications', serializedPost, config)
            .then(response => {
    ...
    const updatePublication = async (publication,  files) => {
        ...
        await axios.post('/api/publications/' + publication.id, serializedPost, config)
            .then(response => {
    ...
    const getPublicationList = async () => {
        axios.get('/api/publication-list')
            .then(response => {
