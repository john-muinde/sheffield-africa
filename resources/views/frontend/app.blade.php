...
<!-- End Google Tag Manager -->
	...
	<!--@vite('resources/js/apps/frontend/assets/css/plugins/magnific-popup/magnific-popup.css')-->
...
<body>
	...
	<!-- @vite('resources/js/apps/frontend/assets/js/jquery.min.js?commonjs-entry') -->
	...
	<!-- @vite('resources/js/apps/frontend/assets/js/owl.carousel.min.js') -->
	@vite('resources/js/apps/frontend/assets/js/bootstrap-input-spinner.js')
	<!--@vite('resources/js/apps/frontend/assets/js/jquery.magnific-popup.min.js?commonjs-entry')-->
